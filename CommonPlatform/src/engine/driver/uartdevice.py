...
class SerialPort(object):
    ...
    rpc_public_api = ["close","connect", "send_read", "send", "send_by_array", "read_until", "read_string"]
        ...
        try:
            while True:
                ...
                if temp:
                    ...
                    # recv += str(temp.decode(errors='ignore')) if isinstance(temp, bytes) else temp

...
export PYTHONPATH=/Users/prm2432/Documents/release_for_mac
# export PYTHONPATH=$PYTHONPATH:$basepath
cd `dirname $0`
cd ..

launcher=/Users/prm2432/Documents/release_for_mac/venv/lib/python3.9/site-packages/rtSque/lynx/launcher
...
if [ -f $HW_PROFILE ]
then
    python3 $launcher/launcher.py -p $HW_PROFILE -s $SW_PROFILE --driver_folder=$DRIVER_FOLDER --driver_folder=$ADDON_DRIVER_FOLDER
else

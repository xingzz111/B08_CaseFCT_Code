...
def power_for_jlink():
    ...
    time.sleep(3)
    print(mix_rpc_client.rpc_call("mixdevice.relay", "PP1V7_LDO_EN"))
    ...
    input("wait_cal")
    print(mix_rpc_client.rpc_call("mixdevice.relay", "AWG811_TO_DUT_TP15_CAL_SQUWAV"))
    print(mix_rpc_client.rpc_call("mixdevice.relay", "UART_FT232_TO_DUT_HALF_DUPLEX"))
...
def cal8300_power():
    ...
    # print(mix_rpc_client.rpc_call("mixdevice.switch_mode", True))
    time.sleep(0.5)
    # print(mix_rpc_client.rpc_call("baseboard.set_io_switch", [[]]))
    # print(mix_rpc_client.rpc_call("mixdevice.relay", "UART_COREBOARD_TO_DUT"))
...
def test4():
    ...
    print("readBuff",info)
    try:
        print(mix_rpc_client.rpc_call("com.write_read", "[2700_status,]\n","\n"))
        time.sleep(3)
    except:
        pass
...
def power_on_for_key():
    mix_rpc_client = MixRpc("169.254.1.32", 7801)
    print(mix_rpc_client.rpc_call("mixdevice.battery_output", 500, 0))
    ...
    # battery 3v7 off
    # print(mix_rpc_client.rpc_call("mixdevice.battery_output", 500, 0))
    # print(mix_rpc_client.rpc_call("mixdevice.relay", "ODIN_BATT_TO_DUT_TP22_BAT_P","DISCONNECT"))
    # #
    # # charge 5v off
    # print(mix_rpc_client.rpc_call("mixdevice.charge_output", 500, 0))
    # print(mix_rpc_client.rpc_call("mixdevice.relay", "ODIN_VCHG_TO_DUT_TP40_POGO5V", "DISCONNECT"))
    # print(mix_rpc_client.rpc_call("mixdevice.charge_output",500,0))
    ...
    # print(mix_rpc_client.rpc_call("mixdevice.relay", "ODIN_BATT_TO_DUT_TP22_BAT_P","DISCONNECT"))
    print(mix_rpc_client.rpc_call("mixdevice.charge_output", 500, 5000))
    print(mix_rpc_client.rpc_call("mixdevice.relay", "ODIN_VCHG_TO_DUT_TP40_POGO5V", "CONNECT"))
    ...
    # input("short key:")
    # # print(mix_rpc_client.rpc_call("mixdevice.relay", "PULL_UP_DUT_TP6_KEY"))
    # # time.sleep(0.5)
    # # print(mix_rpc_client.rpc_call("mixdevice.relay", "PULL_UP_DUT_TP6_KEY", "DISCONNECT"))
    #
    # # input("key off:")
    # print(mix_rpc_client.rpc_call("mixdevice.relay", "PULL_UP_DUT_TP6_KEY"))
    # time.sleep(3)

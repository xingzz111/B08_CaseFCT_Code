...
from socket import *
import zmq
from rtSque.emulator import *
from rtSque import zmqports
from rtSque.loggers import events, levels
from rtSque.loggers.reporter import ReporterProtocol
...
class SeqListener(Thread):
    ...
    def __init__(self, host=None, site=0, queue=None, verbose=False):
        ...
        sub.setsockopt_string(zmq.SUBSCRIBE, zmqports.PUB_CHANNEL)

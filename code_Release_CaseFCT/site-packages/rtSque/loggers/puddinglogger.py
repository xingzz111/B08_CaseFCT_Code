...
class PuddingLogger(FileLogger):
    ...
    def post_init(self):
        ...
        self.fixture_id = ''
        self.priority = ''
        # Ensure attributes exist even if SEQUENCE_START hasn't fired (e.g., step mode)

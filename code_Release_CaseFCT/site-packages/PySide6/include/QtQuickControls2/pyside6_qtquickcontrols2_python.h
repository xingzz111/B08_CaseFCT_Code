...
enum [[deprecated]] : int {
    ...
    SBK_QTQUICKCONTROLS2_QLIST_QOBJECTPTR_IDX                = 4, // QList<QObject*>
    SBK_QTQUICKCONTROLS2_QLIST_QBYTEARRAY_IDX                = 6, // QList<QByteArray>
    SBK_QTQUICKCONTROLS2_QLIST_QVARIANT_IDX                  = 8, // QList<QVariant>
    SBK_QTQUICKCONTROLS2_QLIST_QSTRING_IDX                   = 10, // QList<QString>
    SBK_QTQUICKCONTROLS2_QMAP_QSTRING_QVARIANT_IDX           = 12, // QMap<QString,QVariant>
    SBK_QTQUICKCONTROLS2_CONVERTERS_IDX_COUNT                = 14,
};
...
enum : int {
    ...
    SBK_QtQuickControls2_QList_QObjectPTR_IDX                = 2, // QList<QObject*>
    SBK_QtQuickControls2_QList_QByteArray_IDX                = 3, // QList<QByteArray>
    SBK_QtQuickControls2_QList_QVariant_IDX                  = 4, // QList<QVariant>
    SBK_QtQuickControls2_QList_QString_IDX                   = 5, // QList<QString>
    SBK_QtQuickControls2_QMap_QString_QVariant_IDX           = 6, // QMap<QString,QVariant>
    SBK_QtQuickControls2_CONVERTERS_IDX_COUNT                = 7,
};

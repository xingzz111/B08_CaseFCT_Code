...
enum [[deprecated]] : int {
    ...
    SBK_QFLAGS_QABSTRACTITEMMODEL_CHECKINDEXOPTION_IDX       = 208,
    ...
    SBK_QFLAGS_QBLUETOOTHPERMISSION_COMMUNICATIONMODE_IDX    = 210,
    SBK_QBLUETOOTHPERMISSION_IDX                             = 34,
    SBK_QBUFFER_IDX                                          = 38,
    SBK_QBYTEARRAY_BASE64OPTION_IDX                          = 44,
    SBK_QFLAGS_QBYTEARRAY_BASE64OPTION_IDX                   = 212,
    ...
    SBK_QFLAGS_QCBORVALUE_ENCODINGOPTION_IDX                 = 216,
    SBK_QCBORVALUE_DIAGNOSTICNOTATIONOPTION_IDX              = 96,
    SBK_QFLAGS_QCBORVALUE_DIAGNOSTICNOTATIONOPTION_IDX       = 214,
    ...
    SBK_QFLAGS_QCOMMANDLINEOPTION_FLAG_IDX                   = 218,
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 920,
    ...
    SBK_QFLAGS_QDIR_FILTER_IDX                               = 220,
    SBK_QDIR_SORTFLAG_IDX                                    = 156,
    SBK_QFLAGS_QDIR_SORTFLAG_IDX                             = 222,
    SBK_QDIR_IDX                                             = 152,
    SBK_QDIRITERATOR_ITERATORFLAG_IDX                        = 160,
    SBK_QFLAGS_QDIRITERATOR_ITERATORFLAG_IDX                 = 224,
    SBK_QDIRITERATOR_IDX                                     = 158,
    SBK_QDIRLISTING_ITERATORFLAG_IDX                         = 166,
    SBK_QFLAGS_QDIRLISTING_ITERATORFLAG_IDX                  = 226,
    SBK_QDIRLISTING_IDX                                      = 162,
    SBK_QDIRLISTING_DIRENTRY_IDX                             = 164,
    SBK_QDYNAMICPROPERTYCHANGEEVENT_IDX                      = 168,
    SBK_QEASINGCURVE_TYPE_IDX                                = 172,
    SBK_QEASINGCURVE_IDX                                     = 170,
    SBK_QELAPSEDTIMER_CLOCKTYPE_IDX                          = 176,
    SBK_QELAPSEDTIMER_IDX                                    = 174,
    SBK_QEVENT_TYPE_IDX                                      = 180,
    SBK_QEVENT_IDX                                           = 178,
    SBK_QEVENTLOOP_PROCESSEVENTSFLAG_IDX                     = 184,
    SBK_QFLAGS_QEVENTLOOP_PROCESSEVENTSFLAG_IDX              = 228,
    SBK_QEVENTLOOP_IDX                                       = 182,
    SBK_QFACTORYINTERFACE_IDX                                = 186,
    SBK_QFILE_IDX                                            = 188,
    SBK_QFILEDEVICE_FILEERROR_IDX                            = 192,
    SBK_QFILEDEVICE_FILETIME_IDX                             = 196,
    SBK_QFILEDEVICE_PERMISSION_IDX                           = 200,
    SBK_QFLAGS_QFILEDEVICE_PERMISSION_IDX                    = 234,
    SBK_QFILEDEVICE_FILEHANDLEFLAG_IDX                       = 194,
    SBK_QFLAGS_QFILEDEVICE_FILEHANDLEFLAG_IDX                = 230,
    SBK_QFILEDEVICE_MEMORYMAPFLAG_IDX                        = 198,
    SBK_QFLAGS_QFILEDEVICE_MEMORYMAPFLAG_IDX                 = 232,
    SBK_QFILEDEVICE_IDX                                      = 190,
    SBK_QFILEINFO_IDX                                        = 202,
    SBK_QFILESELECTOR_IDX                                    = 204,
    SBK_QFILESYSTEMWATCHER_IDX                               = 206,
    SBK_QFUTUREINTERFACEBASE_STATE_IDX                       = 322,
    SBK_QFUTUREINTERFACEBASE_CANCELMODE_IDX                  = 320,
    SBK_QFUTUREINTERFACEBASE_IDX                             = 318,
    SBK_QGENERICARGUMENT_IDX                                 = 324,
    SBK_QGENERICRETURNARGUMENT_IDX                           = 326,
    SBK_QHASHSEED_IDX                                        = 328,
    SBK_QIODEVICE_IDX                                        = 330,
    SBK_QIODEVICEBASE_OPENMODEFLAG_IDX                       = 334,
    SBK_QFLAGS_QIODEVICEBASE_OPENMODEFLAG_IDX                = 236,
    SBK_QIODEVICEBASE_IDX                                    = 332,
    SBK_QIDENTITYPROXYMODEL_IDX                              = 336,
    SBK_QITEMSELECTION_IDX                                   = 338,
    SBK_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX                = 342,
    SBK_QFLAGS_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX         = 238,
    SBK_QITEMSELECTIONMODEL_IDX                              = 340,
    SBK_QITEMSELECTIONRANGE_IDX                              = 344,
    SBK_QJSONARRAY_IDX                                       = 346,
    SBK_QJSONDOCUMENT_JSONFORMAT_IDX                         = 350,
    SBK_QJSONDOCUMENT_IDX                                    = 348,
    SBK_QJSONPARSEERROR_PARSEERROR_IDX                       = 354,
    SBK_QJSONPARSEERROR_IDX                                  = 352,
    SBK_QJSONVALUE_TYPE_IDX                                  = 358,
    SBK_QJSONVALUE_IDX                                       = 356,
    SBK_QKEYCOMBINATION_IDX                                  = 360,
    SBK_QLIBRARY_LOADHINT_IDX                                = 364,
    SBK_QFLAGS_QLIBRARY_LOADHINT_IDX                         = 240,
    SBK_QLIBRARY_IDX                                         = 362,
    SBK_QLIBRARYINFO_LIBRARYPATH_IDX                         = 368,
    SBK_QLIBRARYINFO_IDX                                     = 366,
    SBK_QLINE_IDX                                            = 370,
    SBK_QLINEF_INTERSECTIONTYPE_IDX                          = 374,
    SBK_QLINEF_IDX                                           = 372,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 386,
    SBK_QLOCALE_SCRIPT_IDX                                   = 926,
    SBK_QLOCALE_COUNTRY_IDX                                  = 378,
    SBK_QLOCALE_MEASUREMENTSYSTEM_IDX                        = 390,
    SBK_QLOCALE_FORMATTYPE_IDX                               = 384,
    SBK_QLOCALE_NUMBEROPTION_IDX                             = 392,
    SBK_QFLAGS_QLOCALE_NUMBEROPTION_IDX                      = 246,
    SBK_QLOCALE_FLOATINGPOINTPRECISIONOPTION_IDX             = 382,
    SBK_QLOCALE_TAGSEPARATOR_IDX                             = 394,
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 922,
    SBK_QLOCALE_DATASIZEFORMAT_IDX                           = 380,
    SBK_QFLAGS_QLOCALE_DATASIZEFORMAT_IDX                    = 242,
    SBK_QLOCALE_LANGUAGECODETYPE_IDX                         = 388,
    SBK_QFLAGS_QLOCALE_LANGUAGECODETYPE_IDX                  = 244,
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 924,
    SBK_QLOCALE_IDX                                          = 376,
    SBK_QLOCATIONPERMISSION_ACCURACY_IDX                     = 398,
    SBK_QLOCATIONPERMISSION_AVAILABILITY_IDX                 = 400,
    SBK_QLOCATIONPERMISSION_IDX                              = 396,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 404,
    SBK_QLOCKFILE_IDX                                        = 402,
    SBK_QLOGGINGCATEGORY_IDX                                 = 406,
    SBK_QMARGINS_IDX                                         = 408,
    SBK_QMARGINSF_IDX                                        = 410,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 412,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 414,
    SBK_QMETACLASSINFO_IDX                                   = 416,
    SBK_QMETAENUM_IDX                                        = 418,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 422,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 424,
    SBK_QMETAMETHOD_IDX                                      = 420,
    SBK_QMETAOBJECT_CALL_IDX                                 = 428,
    SBK_QMETAOBJECT_IDX                                      = 426,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 430,
    SBK_QMETAPROPERTY_IDX                                    = 432,
    SBK_QMETATYPE_TYPE_IDX                                   = 436,
    SBK_QMETATYPE_TYPEFLAG_IDX                               = 438,
    SBK_QFLAGS_QMETATYPE_TYPEFLAG_IDX                        = 248,
    SBK_QMETATYPE_IDX                                        = 434,
    SBK_QMICROPHONEPERMISSION_IDX                            = 440,
    SBK_QMIMEDATA_IDX                                        = 442,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 446,
    SBK_QMIMEDATABASE_IDX                                    = 444,
    SBK_QMIMETYPE_IDX                                        = 448,
    SBK_QMODELINDEX_IDX                                      = 450,
    SBK_QMODELROLEDATA_IDX                                   = 452,
    SBK_QMODELROLEDATASPAN_IDX                               = 454,
    SBK_QMUTEX_IDX                                           = 456,
    SBK_QNATIVEIPCKEY_TYPE_IDX                               = 460,
    SBK_QNATIVEIPCKEY_IDX                                    = 458,
    SBK_QOBJECT_IDX                                          = 462,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 464,
    SBK_QOPERATINGSYSTEMVERSIONBASE_OSTYPE_IDX               = 468,
    SBK_QOPERATINGSYSTEMVERSIONBASE_IDX                      = 466,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 470,
    SBK_QPAUSEANIMATION_IDX                                  = 472,
    SBK_QPERMISSION_IDX                                      = 474,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 476,
    SBK_QPLUGINLOADER_IDX                                    = 478,
    SBK_QPOINT_IDX                                           = 480,
    SBK_QPOINTF_IDX                                          = 482,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 494,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 496,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 490,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 492,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 488,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 486,
    SBK_QPROCESS_IDX                                         = 484,
    SBK_QPROCESSENVIRONMENT_INITIALIZATION_IDX               = 500,
    SBK_QPROCESSENVIRONMENT_IDX                              = 498,
    SBK_QPROPERTYANIMATION_IDX                               = 502,
    SBK_QRANDOMGENERATOR_IDX                                 = 504,
    SBK_QRANDOMGENERATOR64_IDX                               = 506,
    SBK_QREADLOCKER_IDX                                      = 508,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 512,
    SBK_QREADWRITELOCK_IDX                                   = 510,
    SBK_QRECT_IDX                                            = 514,
    SBK_QRECTF_IDX                                           = 516,
    SBK_QRECURSIVEMUTEX_IDX                                  = 518,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 526,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 252,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 524,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 522,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 250,
    SBK_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX      = 528,
    SBK_QFLAGS_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX = 254,
    SBK_QREGULAREXPRESSION_IDX                               = 520,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 530,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 532,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 536,
    SBK_QRESOURCE_IDX                                        = 534,
    SBK_QRUNNABLE_IDX                                        = 538,
    SBK_QSAVEFILE_IDX                                        = 540,
    SBK_QSEMAPHORE_IDX                                       = 542,
    SBK_QSEMAPHORERELEASER_IDX                               = 544,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 546,
    SBK_QSETTINGS_STATUS_IDX                                 = 554,
    SBK_QSETTINGS_FORMAT_IDX                                 = 550,
    SBK_QSETTINGS_SCOPE_IDX                                  = 552,
    SBK_QSETTINGS_IDX                                        = 548,
    SBK_QSHAREDMEMORY_ACCESSMODE_IDX                         = 558,
    SBK_QSHAREDMEMORY_SHAREDMEMORYERROR_IDX                  = 560,
    SBK_QSHAREDMEMORY_IDX                                    = 556,
    SBK_QSIGNALBLOCKER_IDX                                   = 562,
    SBK_QSIGNALMAPPER_IDX                                    = 564,
    SBK_QSIZE_IDX                                            = 566,
    SBK_QSIZEF_IDX                                           = 568,
    SBK_QSOCKETDESCRIPTOR_IDX                                = 570,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 574,
    SBK_QSOCKETNOTIFIER_IDX                                  = 572,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 576,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 582,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 580,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 256,
    SBK_QSTANDARDPATHS_IDX                                   = 578,
    SBK_QSTORAGEINFO_IDX                                     = 584,
    SBK_QSTRINGCONVERTER_ENCODING_IDX                        = 588,
    SBK_QSTRINGCONVERTER_IDX                                 = 586,
    SBK_QSTRINGCONVERTERBASE_FLAG_IDX                        = 592,
    SBK_QFLAGS_QSTRINGCONVERTERBASE_FLAG_IDX                 = 258,
    SBK_QSTRINGCONVERTERBASE_IDX                             = 590,
    SBK_QSTRINGCONVERTERBASE_STATE_IDX                       = 594,
    SBK_QSTRINGDECODER_IDX                                   = 596,
    SBK_QSTRINGENCODER_IDX                                   = 598,
    SBK_QSTRINGLISTMODEL_IDX                                 = 600,
    SBK_QSYSINFO_SIZES_IDX                                   = 606,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 604,
    SBK_QSYSINFO_IDX                                         = 602,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 610,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 612,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 608,
    SBK_QTEMPORARYDIR_IDX                                    = 614,
    SBK_QTEMPORARYFILE_IDX                                   = 616,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 622,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 620,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 260,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 618,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 630,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 626,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 632,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 628,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 262,
    SBK_QTEXTSTREAM_IDX                                      = 624,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 634,
    SBK_QTHREAD_PRIORITY_IDX                                 = 638,
    SBK_QTHREAD_IDX                                          = 636,
    SBK_QTHREADPOOL_IDX                                      = 640,
    SBK_QTIME_IDX                                            = 642,
    SBK_QTIMELINE_STATE_IDX                                  = 648,
    SBK_QTIMELINE_DIRECTION_IDX                              = 646,
    SBK_QTIMELINE_IDX                                        = 644,
    SBK_QTIMEZONE_INITIALIZATION_IDX                         = 652,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 658,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 654,
    SBK_QTIMEZONE_IDX                                        = 650,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 656,
    SBK_QTIMER_IDX                                           = 660,
    SBK_QTIMEREVENT_IDX                                      = 662,
    SBK_QTRANSLATOR_IDX                                      = 664,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 666,
    SBK_QURL_PARSINGMODE_IDX                                 = 674,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 676,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 672,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 266,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 678,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 270,
    SBK_QURL_ACEPROCESSINGOPTION_IDX                         = 670,
    SBK_QFLAGS_QURL_ACEPROCESSINGOPTION_IDX                  = 264,
    SBK_QURL_IDX                                             = 668,
    SBK_QURLQUERY_IDX                                        = 680,
    SBK_QUUID_VARIANT_IDX                                    = 686,
    SBK_QUUID_VERSION_IDX                                    = 688,
    SBK_QUUID_STRINGFORMAT_IDX                               = 684,
    SBK_QUUID_IDX                                            = 682,
    SBK_QVARIANTANIMATION_IDX                                = 690,
    SBK_QVERSIONNUMBER_IDX                                   = 692,
    SBK_QWAITCONDITION_IDX                                   = 694,
    SBK_QWINEVENTNOTIFIER_IDX                                = 696,
    SBK_QWRITELOCKER_IDX                                     = 698,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 700,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 702,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 704,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 706,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 708,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 710,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 718,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 716,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 714,
    SBK_QXMLSTREAMREADER_IDX                                 = 712,
    SBK_QXMLSTREAMWRITER_IDX                                 = 720,
    SBK_QT_GLOBALCOLOR_IDX                                   = 794,
    SBK_QT_COLORSCHEME_IDX                                   = 750,
    SBK_QT_MOUSEBUTTON_IDX                                   = 826,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 298,
    SBK_QT_ORIENTATION_IDX                                   = 836,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 302,
    SBK_QT_FOCUSPOLICY_IDX                                   = 784,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 864,
    SBK_QT_SORTORDER_IDX                                     = 860,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 862,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 306,
    SBK_QT_TILERULE_IDX                                      = 874,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 724,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 272,
    SBK_QT_TEXTFLAG_IDX                                      = 868,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 866,
    SBK_QT_WHITESPACEMODE_IDX                                = 894,
    SBK_QT_HITTESTACCURACY_IDX                               = 798,
    SBK_QT_WINDOWTYPE_IDX                                    = 904,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 316,
    SBK_QT_WINDOWSTATE_IDX                                   = 902,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 314,
    SBK_QT_APPLICATIONSTATE_IDX                              = 730,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 274,
    SBK_QT_SCREENORIENTATION_IDX                             = 848,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 304,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 896,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 728,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 800,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 286,
    SBK_QT_BGMODE_IDX                                        = 738,
    SBK_QT_KEY_IDX                                           = 814,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 816,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 294,
    SBK_QT_MODIFIER_IDX                                      = 824,
    SBK_QT_ARROWTYPE_IDX                                     = 732,
    SBK_QT_PENSTYLE_IDX                                      = 842,
    SBK_QT_PENCAPSTYLE_IDX                                   = 838,
    SBK_QT_PENJOINSTYLE_IDX                                  = 840,
    SBK_QT_BRUSHSTYLE_IDX                                    = 740,
    SBK_QT_SIZEMODE_IDX                                      = 858,
    SBK_QT_UIEFFECT_IDX                                      = 892,
    SBK_QT_CURSORSHAPE_IDX                                   = 762,
    SBK_QT_TEXTFORMAT_IDX                                    = 870,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 734,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 768,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 276,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 770,
    SBK_QT_TOOLBARAREA_IDX                                   = 882,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 310,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 884,
    SBK_QT_DATEFORMAT_IDX                                    = 764,
    SBK_QT_TIMESPEC_IDX                                      = 876,
    SBK_QT_DAYOFWEEK_IDX                                     = 766,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 850,
    SBK_QT_CASESENSITIVITY_IDX                               = 742,
    SBK_QT_CORNER_IDX                                        = 760,
    SBK_QT_EDGE_IDX                                          = 774,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 280,
    SBK_QT_CONNECTIONTYPE_IDX                                = 752,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 854,
    SBK_QT_FILLRULE_IDX                                      = 780,
    SBK_QT_MASKMODE_IDX                                      = 820,
    SBK_QT_CLIPOPERATION_IDX                                 = 748,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 810,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 812,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 890,
    SBK_QT_AXIS_IDX                                          = 736,
    SBK_QT_FOCUSREASON_IDX                                   = 786,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 754,
    SBK_QT_CONTEXTMENUTRIGGER_IDX                            = 756,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 804,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 290,
    SBK_QT_INPUTMETHODHINT_IDX                               = 802,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 288,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 776,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 886,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 818,
    SBK_QT_ANCHORPOINT_IDX                                   = 726,
    SBK_QT_FINDCHILDOPTION_IDX                               = 782,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 282,
    SBK_QT_DROPACTION_IDX                                    = 772,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 278,
    SBK_QT_CHECKSTATE_IDX                                    = 744,
    SBK_QT_ITEMDATAROLE_IDX                                  = 806,
    SBK_QT_ITEMFLAG_IDX                                      = 808,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 292,
    SBK_QT_MATCHFLAG_IDX                                     = 822,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 296,
    SBK_QT_WINDOWMODALITY_IDX                                = 900,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 872,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 308,
    SBK_QT_EVENTPRIORITY_IDX                                 = 778,
    SBK_QT_SIZEHINT_IDX                                      = 856,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 898,
    SBK_QT_COORDINATESYSTEM_IDX                              = 758,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 888,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 312,
    SBK_QT_GESTURESTATE_IDX                                  = 790,
    SBK_QT_GESTURETYPE_IDX                                   = 792,
    SBK_QT_GESTUREFLAG_IDX                                   = 788,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 284,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 832,
    SBK_QT_NAVIGATIONMODE_IDX                                = 834,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 928,
    SBK_QT_TIMERTYPE_IDX                                     = 880,
    SBK_QT_TIMERID_IDX                                       = 878,
    SBK_QT_SCROLLPHASE_IDX                                   = 852,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 830,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 828,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 300,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 746,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 796,
    SBK_QT_PERMISSIONSTATUS_IDX                              = 844,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 846,
    SBK_QTCOREQT_IDX                                         = 722,
    SBK_QTCOREHELPER_QDIRLISTINGITERATOR_IDX                 = 908,
    SBK_QTCOREHELPER_QGENERICARGUMENTHOLDER_IDX              = 910,
    SBK_QTCOREHELPER_QGENERICRETURNARGUMENTHOLDER_IDX        = 912,
    SBK_QTCOREHELPER_QIOPIPE_IDX                             = 914,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 916,
    SBK_QCBORKNOWNTAGS_IDX                                   = 72,
    SBK_QCBORSIMPLETYPE_IDX                                  = 78,
    SBK_QCBORTAG_IDX                                         = 92,
    SBK_QTMSGTYPE_IDX                                        = 918,
    SBK_QTCORE_IDX_COUNT                                     = 930,
};
...
enum : int {
    ...
    SBK_QFlags_QAbstractItemModel_CheckIndexOption_IDX       = 104,
    ...
    SBK_QFlags_QBluetoothPermission_CommunicationMode_IDX    = 105,
    SBK_QBluetoothPermission_IDX                             = 17,
    SBK_QBuffer_IDX                                          = 19,
    SBK_QByteArray_Base64Option_IDX                          = 22,
    SBK_QFlags_QByteArray_Base64Option_IDX                   = 106,
    ...
    SBK_QFlags_QCborValue_EncodingOption_IDX                 = 108,
    SBK_QCborValue_DiagnosticNotationOption_IDX              = 48,
    SBK_QFlags_QCborValue_DiagnosticNotationOption_IDX       = 107,
    ...
    SBK_QFlags_QCommandLineOption_Flag_IDX                   = 109,
    ...
    SBK_QCoreApplication_ApplicationFlags_IDX                = 460,
    ...
    SBK_QFlags_QDir_Filter_IDX                               = 110,
    SBK_QDir_SortFlag_IDX                                    = 78,
    SBK_QFlags_QDir_SortFlag_IDX                             = 111,
    SBK_QDir_IDX                                             = 76,
    SBK_QDirIterator_IteratorFlag_IDX                        = 80,
    SBK_QFlags_QDirIterator_IteratorFlag_IDX                 = 112,
    SBK_QDirIterator_IDX                                     = 79,
    SBK_QDirListing_IteratorFlag_IDX                         = 83,
    SBK_QFlags_QDirListing_IteratorFlag_IDX                  = 113,
    SBK_QDirListing_IDX                                      = 81,
    SBK_QDirListing_DirEntry_IDX                             = 82,
    SBK_QDynamicPropertyChangeEvent_IDX                      = 84,
    SBK_QEasingCurve_Type_IDX                                = 86,
    SBK_QEasingCurve_IDX                                     = 85,
    SBK_QElapsedTimer_ClockType_IDX                          = 88,
    SBK_QElapsedTimer_IDX                                    = 87,
    SBK_QEvent_Type_IDX                                      = 90,
    SBK_QEvent_IDX                                           = 89,
    SBK_QEventLoop_ProcessEventsFlag_IDX                     = 92,
    SBK_QFlags_QEventLoop_ProcessEventsFlag_IDX              = 114,
    SBK_QEventLoop_IDX                                       = 91,
    SBK_QFactoryInterface_IDX                                = 93,
    SBK_QFile_IDX                                            = 94,
    SBK_QFileDevice_FileError_IDX                            = 96,
    SBK_QFileDevice_FileTime_IDX                             = 98,
    SBK_QFileDevice_Permission_IDX                           = 100,
    SBK_QFlags_QFileDevice_Permission_IDX                    = 117,
    SBK_QFileDevice_FileHandleFlag_IDX                       = 97,
    SBK_QFlags_QFileDevice_FileHandleFlag_IDX                = 115,
    SBK_QFileDevice_MemoryMapFlag_IDX                        = 99,
    SBK_QFlags_QFileDevice_MemoryMapFlag_IDX                 = 116,
    SBK_QFileDevice_IDX                                      = 95,
    SBK_QFileInfo_IDX                                        = 101,
    SBK_QFileSelector_IDX                                    = 102,
    SBK_QFileSystemWatcher_IDX                               = 103,
    SBK_QFutureInterfaceBase_State_IDX                       = 161,
    SBK_QFutureInterfaceBase_CancelMode_IDX                  = 160,
    SBK_QFutureInterfaceBase_IDX                             = 159,
    SBK_QGenericArgument_IDX                                 = 162,
    SBK_QGenericReturnArgument_IDX                           = 163,
    SBK_QHashSeed_IDX                                        = 164,
    SBK_QIODevice_IDX                                        = 165,
    SBK_QIODeviceBase_OpenModeFlag_IDX                       = 167,
    SBK_QFlags_QIODeviceBase_OpenModeFlag_IDX                = 118,
    SBK_QIODeviceBase_IDX                                    = 166,
    SBK_QIdentityProxyModel_IDX                              = 168,
    SBK_QItemSelection_IDX                                   = 169,
    SBK_QItemSelectionModel_SelectionFlag_IDX                = 171,
    SBK_QFlags_QItemSelectionModel_SelectionFlag_IDX         = 119,
    SBK_QItemSelectionModel_IDX                              = 170,
    SBK_QItemSelectionRange_IDX                              = 172,
    SBK_QJsonArray_IDX                                       = 173,
    SBK_QJsonDocument_JsonFormat_IDX                         = 175,
    SBK_QJsonDocument_IDX                                    = 174,
    SBK_QJsonParseError_ParseError_IDX                       = 177,
    SBK_QJsonParseError_IDX                                  = 176,
    SBK_QJsonValue_Type_IDX                                  = 179,
    SBK_QJsonValue_IDX                                       = 178,
    SBK_QKeyCombination_IDX                                  = 180,
    SBK_QLibrary_LoadHint_IDX                                = 182,
    SBK_QFlags_QLibrary_LoadHint_IDX                         = 120,
    SBK_QLibrary_IDX                                         = 181,
    SBK_QLibraryInfo_LibraryPath_IDX                         = 184,
    SBK_QLibraryInfo_IDX                                     = 183,
    SBK_QLine_IDX                                            = 185,
    SBK_QLineF_IntersectionType_IDX                          = 187,
    SBK_QLineF_IDX                                           = 186,
    SBK_QLocale_Language_IDX                                 = 193,
    SBK_QLocale_Script_IDX                                   = 463,
    SBK_QLocale_Country_IDX                                  = 189,
    SBK_QLocale_MeasurementSystem_IDX                        = 195,
    SBK_QLocale_FormatType_IDX                               = 192,
    SBK_QLocale_NumberOption_IDX                             = 196,
    SBK_QFlags_QLocale_NumberOption_IDX                      = 123,
    SBK_QLocale_FloatingPointPrecisionOption_IDX             = 191,
    SBK_QLocale_TagSeparator_IDX                             = 197,
    SBK_QLocale_CurrencySymbolFormat_IDX                     = 461,
    SBK_QLocale_DataSizeFormat_IDX                           = 190,
    SBK_QFlags_QLocale_DataSizeFormat_IDX                    = 121,
    SBK_QLocale_LanguageCodeType_IDX                         = 194,
    SBK_QFlags_QLocale_LanguageCodeType_IDX                  = 122,
    SBK_QLocale_QuotationStyle_IDX                           = 462,
    SBK_QLocale_IDX                                          = 188,
    SBK_QLocationPermission_Accuracy_IDX                     = 199,
    SBK_QLocationPermission_Availability_IDX                 = 200,
    SBK_QLocationPermission_IDX                              = 198,
    SBK_QLockFile_LockError_IDX                              = 202,
    SBK_QLockFile_IDX                                        = 201,
    SBK_QLoggingCategory_IDX                                 = 203,
    SBK_QMargins_IDX                                         = 204,
    SBK_QMarginsF_IDX                                        = 205,
    SBK_QMessageAuthenticationCode_IDX                       = 206,
    SBK_QMessageLogContext_IDX                               = 207,
    SBK_QMetaClassInfo_IDX                                   = 208,
    SBK_QMetaEnum_IDX                                        = 209,
    SBK_QMetaMethod_Access_IDX                               = 211,
    SBK_QMetaMethod_MethodType_IDX                           = 212,
    SBK_QMetaMethod_IDX                                      = 210,
    SBK_QMetaObject_Call_IDX                                 = 214,
    SBK_QMetaObject_IDX                                      = 213,
    SBK_QMetaObject_Connection_IDX                           = 215,
    SBK_QMetaProperty_IDX                                    = 216,
    SBK_QMetaType_Type_IDX                                   = 218,
    SBK_QMetaType_TypeFlag_IDX                               = 219,
    SBK_QFlags_QMetaType_TypeFlag_IDX                        = 124,
    SBK_QMetaType_IDX                                        = 217,
    SBK_QMicrophonePermission_IDX                            = 220,
    SBK_QMimeData_IDX                                        = 221,
    SBK_QMimeDatabase_MatchMode_IDX                          = 223,
    SBK_QMimeDatabase_IDX                                    = 222,
    SBK_QMimeType_IDX                                        = 224,
    SBK_QModelIndex_IDX                                      = 225,
    SBK_QModelRoleData_IDX                                   = 226,
    SBK_QModelRoleDataSpan_IDX                               = 227,
    SBK_QMutex_IDX                                           = 228,
    SBK_QNativeIpcKey_Type_IDX                               = 230,
    SBK_QNativeIpcKey_IDX                                    = 229,
    SBK_QObject_IDX                                          = 231,
    SBK_QOperatingSystemVersion_IDX                          = 232,
    SBK_QOperatingSystemVersionBase_OSType_IDX               = 234,
    SBK_QOperatingSystemVersionBase_IDX                      = 233,
    SBK_QParallelAnimationGroup_IDX                          = 235,
    SBK_QPauseAnimation_IDX                                  = 236,
    SBK_QPermission_IDX                                      = 237,
    SBK_QPersistentModelIndex_IDX                            = 238,
    SBK_QPluginLoader_IDX                                    = 239,
    SBK_QPoint_IDX                                           = 240,
    SBK_QPointF_IDX                                          = 241,
    SBK_QProcess_ProcessError_IDX                            = 247,
    SBK_QProcess_ProcessState_IDX                            = 248,
    SBK_QProcess_ProcessChannel_IDX                          = 245,
    SBK_QProcess_ProcessChannelMode_IDX                      = 246,
    SBK_QProcess_InputChannelMode_IDX                        = 244,
    SBK_QProcess_ExitStatus_IDX                              = 243,
    SBK_QProcess_IDX                                         = 242,
    SBK_QProcessEnvironment_Initialization_IDX               = 250,
    SBK_QProcessEnvironment_IDX                              = 249,
    SBK_QPropertyAnimation_IDX                               = 251,
    SBK_QRandomGenerator_IDX                                 = 252,
    SBK_QRandomGenerator64_IDX                               = 253,
    SBK_QReadLocker_IDX                                      = 254,
    SBK_QReadWriteLock_RecursionMode_IDX                     = 256,
    SBK_QReadWriteLock_IDX                                   = 255,
    SBK_QRect_IDX                                            = 257,
    SBK_QRectF_IDX                                           = 258,
    SBK_QRecursiveMutex_IDX                                  = 259,
    SBK_QRegularExpression_PatternOption_IDX                 = 263,
    SBK_QFlags_QRegularExpression_PatternOption_IDX          = 126,
    SBK_QRegularExpression_MatchType_IDX                     = 262,
    SBK_QRegularExpression_MatchOption_IDX                   = 261,
    SBK_QFlags_QRegularExpression_MatchOption_IDX            = 125,
    SBK_QRegularExpression_WildcardConversionOption_IDX      = 264,
    SBK_QFlags_QRegularExpression_WildcardConversionOption_IDX = 127,
    SBK_QRegularExpression_IDX                               = 260,
    SBK_QRegularExpressionMatch_IDX                          = 265,
    SBK_QRegularExpressionMatchIterator_IDX                  = 266,
    SBK_QResource_Compression_IDX                            = 268,
    SBK_QResource_IDX                                        = 267,
    SBK_QRunnable_IDX                                        = 269,
    SBK_QSaveFile_IDX                                        = 270,
    SBK_QSemaphore_IDX                                       = 271,
    SBK_QSemaphoreReleaser_IDX                               = 272,
    SBK_QSequentialAnimationGroup_IDX                        = 273,
    SBK_QSettings_Status_IDX                                 = 277,
    SBK_QSettings_Format_IDX                                 = 275,
    SBK_QSettings_Scope_IDX                                  = 276,
    SBK_QSettings_IDX                                        = 274,
    SBK_QSharedMemory_AccessMode_IDX                         = 279,
    SBK_QSharedMemory_SharedMemoryError_IDX                  = 280,
    SBK_QSharedMemory_IDX                                    = 278,
    SBK_QSignalBlocker_IDX                                   = 281,
    SBK_QSignalMapper_IDX                                    = 282,
    SBK_QSize_IDX                                            = 283,
    SBK_QSizeF_IDX                                           = 284,
    SBK_QSocketDescriptor_IDX                                = 285,
    SBK_QSocketNotifier_Type_IDX                             = 287,
    SBK_QSocketNotifier_IDX                                  = 286,
    SBK_QSortFilterProxyModel_IDX                            = 288,
    SBK_QStandardPaths_StandardLocation_IDX                  = 291,
    SBK_QStandardPaths_LocateOption_IDX                      = 290,
    SBK_QFlags_QStandardPaths_LocateOption_IDX               = 128,
    SBK_QStandardPaths_IDX                                   = 289,
    SBK_QStorageInfo_IDX                                     = 292,
    SBK_QStringConverter_Encoding_IDX                        = 294,
    SBK_QStringConverter_IDX                                 = 293,
    SBK_QStringConverterBase_Flag_IDX                        = 296,
    SBK_QFlags_QStringConverterBase_Flag_IDX                 = 129,
    SBK_QStringConverterBase_IDX                             = 295,
    SBK_QStringConverterBase_State_IDX                       = 297,
    SBK_QStringDecoder_IDX                                   = 298,
    SBK_QStringEncoder_IDX                                   = 299,
    SBK_QStringListModel_IDX                                 = 300,
    SBK_QSysInfo_Sizes_IDX                                   = 303,
    SBK_QSysInfo_Endian_IDX                                  = 302,
    SBK_QSysInfo_IDX                                         = 301,
    SBK_QSystemSemaphore_AccessMode_IDX                      = 305,
    SBK_QSystemSemaphore_SystemSemaphoreError_IDX            = 306,
    SBK_QSystemSemaphore_IDX                                 = 304,
    SBK_QTemporaryDir_IDX                                    = 307,
    SBK_QTemporaryFile_IDX                                   = 308,
    SBK_QTextBoundaryFinder_BoundaryType_IDX                 = 311,
    SBK_QTextBoundaryFinder_BoundaryReason_IDX               = 310,
    SBK_QFlags_QTextBoundaryFinder_BoundaryReason_IDX        = 130,
    SBK_QTextBoundaryFinder_IDX                              = 309,
    SBK_QTextStream_RealNumberNotation_IDX                   = 315,
    SBK_QTextStream_FieldAlignment_IDX                       = 313,
    SBK_QTextStream_Status_IDX                               = 316,
    SBK_QTextStream_NumberFlag_IDX                           = 314,
    SBK_QFlags_QTextStream_NumberFlag_IDX                    = 131,
    SBK_QTextStream_IDX                                      = 312,
    SBK_QTextStreamManipulator_IDX                           = 317,
    SBK_QThread_Priority_IDX                                 = 319,
    SBK_QThread_IDX                                          = 318,
    SBK_QThreadPool_IDX                                      = 320,
    SBK_QTime_IDX                                            = 321,
    SBK_QTimeLine_State_IDX                                  = 324,
    SBK_QTimeLine_Direction_IDX                              = 323,
    SBK_QTimeLine_IDX                                        = 322,
    SBK_QTimeZone_Initialization_IDX                         = 326,
    SBK_QTimeZone_TimeType_IDX                               = 329,
    SBK_QTimeZone_NameType_IDX                               = 327,
    SBK_QTimeZone_IDX                                        = 325,
    SBK_QTimeZone_OffsetData_IDX                             = 328,
    SBK_QTimer_IDX                                           = 330,
    SBK_QTimerEvent_IDX                                      = 331,
    SBK_QTranslator_IDX                                      = 332,
    SBK_QTransposeProxyModel_IDX                             = 333,
    SBK_QUrl_ParsingMode_IDX                                 = 337,
    SBK_QUrl_UrlFormattingOption_IDX                         = 338,
    SBK_QUrl_ComponentFormattingOption_IDX                   = 336,
    SBK_QFlags_QUrl_ComponentFormattingOption_IDX            = 133,
    SBK_QUrl_UserInputResolutionOption_IDX                   = 339,
    SBK_QFlags_QUrl_UserInputResolutionOption_IDX            = 135,
    SBK_QUrl_AceProcessingOption_IDX                         = 335,
    SBK_QFlags_QUrl_AceProcessingOption_IDX                  = 132,
    SBK_QUrl_IDX                                             = 334,
    SBK_QUrlQuery_IDX                                        = 340,
    SBK_QUuid_Variant_IDX                                    = 343,
    SBK_QUuid_Version_IDX                                    = 344,
    SBK_QUuid_StringFormat_IDX                               = 342,
    SBK_QUuid_IDX                                            = 341,
    SBK_QVariantAnimation_IDX                                = 345,
    SBK_QVersionNumber_IDX                                   = 346,
    SBK_QWaitCondition_IDX                                   = 347,
    SBK_QWinEventNotifier_IDX                                = 348,
    SBK_QWriteLocker_IDX                                     = 349,
    SBK_QXmlStreamAttribute_IDX                              = 350,
    SBK_QXmlStreamAttributes_IDX                             = 351,
    SBK_QXmlStreamEntityDeclaration_IDX                      = 352,
    SBK_QXmlStreamEntityResolver_IDX                         = 353,
    SBK_QXmlStreamNamespaceDeclaration_IDX                   = 354,
    SBK_QXmlStreamNotationDeclaration_IDX                    = 355,
    SBK_QXmlStreamReader_TokenType_IDX                       = 359,
    SBK_QXmlStreamReader_ReadElementTextBehaviour_IDX        = 358,
    SBK_QXmlStreamReader_Error_IDX                           = 357,
    SBK_QXmlStreamReader_IDX                                 = 356,
    SBK_QXmlStreamWriter_IDX                                 = 360,
    SBK_Qt_GlobalColor_IDX                                   = 397,
    SBK_Qt_ColorScheme_IDX                                   = 375,
    SBK_Qt_MouseButton_IDX                                   = 413,
    SBK_QFlags_Qt_MouseButton_IDX                            = 149,
    SBK_Qt_Orientation_IDX                                   = 418,
    SBK_QFlags_Qt_Orientation_IDX                            = 151,
    SBK_Qt_FocusPolicy_IDX                                   = 392,
    SBK_Qt_TabFocusBehavior_IDX                              = 432,
    SBK_Qt_SortOrder_IDX                                     = 430,
    SBK_Qt_SplitBehaviorFlags_IDX                            = 431,
    SBK_QFlags_Qt_SplitBehaviorFlags_IDX                     = 153,
    SBK_Qt_TileRule_IDX                                      = 437,
    SBK_Qt_AlignmentFlag_IDX                                 = 362,
    SBK_QFlags_Qt_AlignmentFlag_IDX                          = 136,
    SBK_Qt_TextFlag_IDX                                      = 434,
    SBK_Qt_TextElideMode_IDX                                 = 433,
    SBK_Qt_WhiteSpaceMode_IDX                                = 447,
    SBK_Qt_HitTestAccuracy_IDX                               = 399,
    SBK_Qt_WindowType_IDX                                    = 452,
    SBK_QFlags_Qt_WindowType_IDX                             = 158,
    SBK_Qt_WindowState_IDX                                   = 451,
    SBK_QFlags_Qt_WindowState_IDX                            = 157,
    SBK_Qt_ApplicationState_IDX                              = 365,
    SBK_QFlags_Qt_ApplicationState_IDX                       = 137,
    SBK_Qt_ScreenOrientation_IDX                             = 424,
    SBK_QFlags_Qt_ScreenOrientation_IDX                      = 152,
    SBK_Qt_WidgetAttribute_IDX                               = 448,
    SBK_Qt_ApplicationAttribute_IDX                          = 364,
    SBK_Qt_ImageConversionFlag_IDX                           = 400,
    SBK_QFlags_Qt_ImageConversionFlag_IDX                    = 143,
    SBK_Qt_BGMode_IDX                                        = 369,
    SBK_Qt_Key_IDX                                           = 407,
    SBK_Qt_KeyboardModifier_IDX                              = 408,
    SBK_QFlags_Qt_KeyboardModifier_IDX                       = 147,
    SBK_Qt_Modifier_IDX                                      = 412,
    SBK_Qt_ArrowType_IDX                                     = 366,
    SBK_Qt_PenStyle_IDX                                      = 421,
    SBK_Qt_PenCapStyle_IDX                                   = 419,
    SBK_Qt_PenJoinStyle_IDX                                  = 420,
    SBK_Qt_BrushStyle_IDX                                    = 370,
    SBK_Qt_SizeMode_IDX                                      = 429,
    SBK_Qt_UIEffect_IDX                                      = 446,
    SBK_Qt_CursorShape_IDX                                   = 381,
    SBK_Qt_TextFormat_IDX                                    = 435,
    SBK_Qt_AspectRatioMode_IDX                               = 367,
    SBK_Qt_DockWidgetArea_IDX                                = 384,
    SBK_QFlags_Qt_DockWidgetArea_IDX                         = 138,
    SBK_Qt_DockWidgetAreaSizes_IDX                           = 385,
    SBK_Qt_ToolBarArea_IDX                                   = 441,
    SBK_QFlags_Qt_ToolBarArea_IDX                            = 155,
    SBK_Qt_ToolBarAreaSizes_IDX                              = 442,
    SBK_Qt_DateFormat_IDX                                    = 382,
    SBK_Qt_TimeSpec_IDX                                      = 438,
    SBK_Qt_DayOfWeek_IDX                                     = 383,
    SBK_Qt_ScrollBarPolicy_IDX                               = 425,
    SBK_Qt_CaseSensitivity_IDX                               = 371,
    SBK_Qt_Corner_IDX                                        = 380,
    SBK_Qt_Edge_IDX                                          = 387,
    SBK_QFlags_Qt_Edge_IDX                                   = 140,
    SBK_Qt_ConnectionType_IDX                                = 376,
    SBK_Qt_ShortcutContext_IDX                               = 427,
    SBK_Qt_FillRule_IDX                                      = 390,
    SBK_Qt_MaskMode_IDX                                      = 410,
    SBK_Qt_ClipOperation_IDX                                 = 374,
    SBK_Qt_ItemSelectionMode_IDX                             = 405,
    SBK_Qt_ItemSelectionOperation_IDX                        = 406,
    SBK_Qt_TransformationMode_IDX                            = 445,
    SBK_Qt_Axis_IDX                                          = 368,
    SBK_Qt_FocusReason_IDX                                   = 393,
    SBK_Qt_ContextMenuPolicy_IDX                             = 377,
    SBK_Qt_ContextMenuTrigger_IDX                            = 378,
    SBK_Qt_InputMethodQuery_IDX                              = 402,
    SBK_QFlags_Qt_InputMethodQuery_IDX                       = 145,
    SBK_Qt_InputMethodHint_IDX                               = 401,
    SBK_QFlags_Qt_InputMethodHint_IDX                        = 144,
    SBK_Qt_EnterKeyType_IDX                                  = 388,
    SBK_Qt_ToolButtonStyle_IDX                               = 443,
    SBK_Qt_LayoutDirection_IDX                               = 409,
    SBK_Qt_AnchorPoint_IDX                                   = 363,
    SBK_Qt_FindChildOption_IDX                               = 391,
    SBK_QFlags_Qt_FindChildOption_IDX                        = 141,
    SBK_Qt_DropAction_IDX                                    = 386,
    SBK_QFlags_Qt_DropAction_IDX                             = 139,
    SBK_Qt_CheckState_IDX                                    = 372,
    SBK_Qt_ItemDataRole_IDX                                  = 403,
    SBK_Qt_ItemFlag_IDX                                      = 404,
    SBK_QFlags_Qt_ItemFlag_IDX                               = 146,
    SBK_Qt_MatchFlag_IDX                                     = 411,
    SBK_QFlags_Qt_MatchFlag_IDX                              = 148,
    SBK_Qt_WindowModality_IDX                                = 450,
    SBK_Qt_TextInteractionFlag_IDX                           = 436,
    SBK_QFlags_Qt_TextInteractionFlag_IDX                    = 154,
    SBK_Qt_EventPriority_IDX                                 = 389,
    SBK_Qt_SizeHint_IDX                                      = 428,
    SBK_Qt_WindowFrameSection_IDX                            = 449,
    SBK_Qt_CoordinateSystem_IDX                              = 379,
    SBK_Qt_TouchPointState_IDX                               = 444,
    SBK_QFlags_Qt_TouchPointState_IDX                        = 156,
    SBK_Qt_GestureState_IDX                                  = 395,
    SBK_Qt_GestureType_IDX                                   = 396,
    SBK_Qt_GestureFlag_IDX                                   = 394,
    SBK_QFlags_Qt_GestureFlag_IDX                            = 142,
    SBK_Qt_NativeGestureType_IDX                             = 416,
    SBK_Qt_NavigationMode_IDX                                = 417,
    SBK_Qt_CursorMoveStyle_IDX                               = 464,
    SBK_Qt_TimerType_IDX                                     = 440,
    SBK_Qt_TimerId_IDX                                       = 439,
    SBK_Qt_ScrollPhase_IDX                                   = 426,
    SBK_Qt_MouseEventSource_IDX                              = 415,
    SBK_Qt_MouseEventFlag_IDX                                = 414,
    SBK_QFlags_Qt_MouseEventFlag_IDX                         = 150,
    SBK_Qt_ChecksumType_IDX                                  = 373,
    SBK_Qt_HighDpiScaleFactorRoundingPolicy_IDX              = 398,
    SBK_Qt_PermissionStatus_IDX                              = 422,
    SBK_Qt_ReturnByValueConstant_IDX                         = 423,
    SBK_QtCoreQt_IDX                                         = 361,
    SBK_QtCoreHelper_QDirListingIterator_IDX                 = 454,
    SBK_QtCoreHelper_QGenericArgumentHolder_IDX              = 455,
    SBK_QtCoreHelper_QGenericReturnArgumentHolder_IDX        = 456,
    SBK_QtCoreHelper_QIOPipe_IDX                             = 457,
    SBK_QtCoreHelper_QMutexLocker_IDX                        = 458,
    SBK_QCborKnownTags_IDX                                   = 36,
    SBK_QCborSimpleType_IDX                                  = 39,
    SBK_QCborTag_IDX                                         = 46,
    SBK_QtMsgType_IDX                                        = 459,
    SBK_QtCore_IDX_COUNT                                     = 465,
};
...
enum [[deprecated]] : int {
    ...
    SBK_QPTRDIFF_IDX                                         = 24,
    SBK_QUINTPTR_IDX                                         = 26,
    SBK_QTCORE_QLIST_INT_IDX                                 = 28, // QList<int>
    SBK_QTCORE_QLIST_QPOINT_IDX                              = 30, // QList<QPoint>
    SBK_QTCORE_QLIST_QPOINTF_IDX                             = 32, // QList<QPointF>
    SBK_QTCORE_QLIST_QOBJECTPTR_IDX                          = 34, // QList<QObject*>
    SBK_QTCORE_QLIST_QBYTEARRAY_IDX                          = 36, // QList<QByteArray>
    ...
    SBK_QTCORE_QLIST_QTIMEZONE_OFFSETDATA_IDX                = 60, // QList<QTimeZone::OffsetData>
    SBK_QTCORE_QLIST_QVARIANT_IDX                            = 62, // QList<QVariant>
    SBK_QTCORE_QLIST_QMODELINDEX_IDX                         = 64, // QList<QModelIndex>
    SBK_QTCORE_QLIST_QITEMSELECTIONRANGE_IDX                 = 66, // QList<QItemSelectionRange>
    SBK_QTCORE_QLIST_QURL_IDX                                = 68, // QList<QUrl>
    SBK_QTCORE_QLIST_QFILEINFO_IDX                           = 70, // QList<QFileInfo>
    SBK_QTCORE_QLIST_QCOMMANDLINEOPTION_IDX                  = 72, // QList<QCommandLineOption>
    SBK_QTCORE_QHASH_QSTRING_QVARIANT_IDX                    = 74, // QHash<QString,QVariant>
    SBK_QTCORE_QMAP_QSTRING_QVARIANT_IDX                     = 76, // QMap<QString,QVariant>
    SBK_QTCORE_QLIST_QCBORVALUE_IDX                          = 78, // QList<QCborValue>
    SBK_QTCORE_QMAP_INT_QVARIANT_IDX                         = 80, // QMap<int,QVariant>
    SBK_QTCORE_QLIST_QPERSISTENTMODELINDEX_IDX               = 82, // QList<QPersistentModelIndex>
    SBK_QTCORE_QHASH_INT_QBYTEARRAY_IDX                      = 84, // QHash<int,QByteArray>
    SBK_QTCORE_QLIST_QABSTRACTITEMMODELPTR_IDX               = 86, // QList<QAbstractItemModel*>
    SBK_QTCORE_QLIST_QABSTRACTEVENTDISPATCHER_TIMERINFO_IDX  = 88, // QList<QAbstractEventDispatcher::TimerInfo>
    SBK_QTCORE_STD_PAIR_DOUBLE_QVARIANT_IDX                  = 90, // std::pair<double,QVariant>
    SBK_QTCORE_QLIST_STD_PAIR_DOUBLE_QVARIANT_IDX            = 92, // QList<std::pair<double,QVariant>>
    SBK_QTCORE_QLIST_QSTRING_IDX                             = 94, // QList<QString>
    SBK_QTCORE_CONVERTERS_IDX_COUNT                          = 96,
};
...
enum : int {
    ...
    SBK_qptrdiff_IDX                                         = 12,
    SBK_quintptr_IDX                                         = 13,
    SBK_QtCore_QList_int_IDX                                 = 14, // QList<int>
    SBK_QtCore_QList_QPoint_IDX                              = 15, // QList<QPoint>
    SBK_QtCore_QList_QPointF_IDX                             = 16, // QList<QPointF>
    SBK_QtCore_QList_QObjectPTR_IDX                          = 17, // QList<QObject*>
    SBK_QtCore_QList_QByteArray_IDX                          = 18, // QList<QByteArray>
    ...
    SBK_QtCore_QList_QTimeZone_OffsetData_IDX                = 30, // QList<QTimeZone::OffsetData>
    SBK_QtCore_QList_QVariant_IDX                            = 31, // QList<QVariant>
    SBK_QtCore_QList_QModelIndex_IDX                         = 32, // QList<QModelIndex>
    SBK_QtCore_QList_QItemSelectionRange_IDX                 = 33, // QList<QItemSelectionRange>
    SBK_QtCore_QList_QUrl_IDX                                = 34, // QList<QUrl>
    SBK_QtCore_QList_QFileInfo_IDX                           = 35, // QList<QFileInfo>
    ...
    SBK_QtCore_std_pair_double_QVariant_IDX                  = 45, // std::pair<double,QVariant>
    SBK_QtCore_QList_std_pair_double_QVariant_IDX            = 46, // QList<std::pair<double,QVariant>>

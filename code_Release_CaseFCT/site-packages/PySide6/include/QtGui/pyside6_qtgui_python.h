...
enum [[deprecated]] : int {
    ...
    SBK_QFONT_HINTINGPREFERENCE_IDX                          = 968,
    ...
    SBK_QNATIVEINTERFACE_QWINDOWSSCREEN_IDX                  = 390,
    ...
    SBK_QRHID3D11INITPARAMS_IDX                              = 584,
    SBK_QRHID3D11NATIVEHANDLES_IDX                           = 586,
    SBK_QRHID3D12INITPARAMS_IDX                              = 588,
    SBK_QRHID3D12NATIVEHANDLES_IDX                           = 590,
    ...
    SBK_QRHINATIVEHANDLES_IDX                                = 630,
    SBK_QRHINULLINITPARAMS_IDX                               = 632,
    SBK_QRHIREADBACKDESCRIPTION_IDX                          = 634,
    SBK_QRHIREADBACKRESULT_IDX                               = 636,
    SBK_QRHIRENDERBUFFER_TYPE_IDX                            = 642,
    SBK_QRHIRENDERBUFFER_FLAG_IDX                            = 640,
    SBK_QFLAGS_QRHIRENDERBUFFER_FLAG_IDX                     = 202,
    SBK_QRHIRENDERBUFFER_IDX                                 = 638,
    SBK_QRHIRENDERPASSDESCRIPTOR_IDX                         = 644,
    SBK_QRHIRENDERTARGET_IDX                                 = 646,
    SBK_QRHIRESOURCE_TYPE_IDX                                = 650,
    SBK_QRHIRESOURCE_IDX                                     = 648,
    SBK_QRHIRESOURCEUPDATEBATCH_IDX                          = 652,
    SBK_QRHISAMPLER_FILTER_IDX                               = 660,
    SBK_QRHISAMPLER_ADDRESSMODE_IDX                          = 656,
    SBK_QRHISAMPLER_COMPAREOP_IDX                            = 658,
    SBK_QRHISAMPLER_IDX                                      = 654,
    SBK_QRHISCISSOR_IDX                                      = 662,
    SBK_QRHISHADERRESOURCEBINDING_TYPE_IDX                   = 676,
    SBK_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX              = 672,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX       = 204,
    SBK_QRHISHADERRESOURCEBINDING_IDX                        = 664,
    SBK_QRHISHADERRESOURCEBINDING_DATA_IDX                   = 666,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEBUFFERDATA_IDX = 668,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEIMAGEDATA_IDX  = 670,
    SBK_QRHISHADERRESOURCEBINDING_TEXTUREANDSAMPLER_IDX      = 674,
    SBK_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX            = 680,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX     = 206,
    SBK_QRHISHADERRESOURCEBINDINGS_IDX                       = 678,
    SBK_QRHISHADERSTAGE_TYPE_IDX                             = 684,
    SBK_QRHISHADERSTAGE_IDX                                  = 682,
    SBK_QRHISTATS_IDX                                        = 686,
    SBK_QRHISWAPCHAIN_FLAG_IDX                               = 690,
    SBK_QFLAGS_QRHISWAPCHAIN_FLAG_IDX                        = 208,
    SBK_QRHISWAPCHAIN_FORMAT_IDX                             = 692,
    SBK_QRHISWAPCHAIN_STEREOTARGETBUFFER_IDX                 = 694,
    SBK_QRHISWAPCHAIN_IDX                                    = 688,
    SBK_QRHISWAPCHAINRENDERTARGET_IDX                        = 696,
    SBK_QRHITEXTURE_FLAG_IDX                                 = 700,
    SBK_QFLAGS_QRHITEXTURE_FLAG_IDX                          = 210,
    SBK_QRHITEXTURE_FORMAT_IDX                               = 702,
    SBK_QRHITEXTURE_IDX                                      = 698,
    SBK_QRHITEXTURE_VIEWFORMAT_IDX                           = 704,
    SBK_QRHITEXTURECOPYDESCRIPTION_IDX                       = 706,
    SBK_QRHITEXTURERENDERTARGET_FLAG_IDX                     = 710,
    SBK_QFLAGS_QRHITEXTURERENDERTARGET_FLAG_IDX              = 212,
    SBK_QRHITEXTURERENDERTARGET_IDX                          = 708,
    SBK_QRHITEXTURERENDERTARGETDESCRIPTION_IDX               = 712,
    SBK_QRHITEXTURESUBRESOURCEUPLOADDESCRIPTION_IDX          = 714,
    SBK_QRHITEXTUREUPLOADDESCRIPTION_IDX                     = 716,
    SBK_QRHITEXTUREUPLOADENTRY_IDX                           = 718,
    SBK_QRHIVERTEXINPUTATTRIBUTE_FORMAT_IDX                  = 722,
    SBK_QRHIVERTEXINPUTATTRIBUTE_IDX                         = 720,
    SBK_QRHIVERTEXINPUTBINDING_CLASSIFICATION_IDX            = 726,
    SBK_QRHIVERTEXINPUTBINDING_IDX                           = 724,
    SBK_QRHIVERTEXINPUTLAYOUT_IDX                            = 728,
    SBK_QRHIVIEWPORT_IDX                                     = 730,
    SBK_QSCREEN_IDX                                          = 732,
    SBK_QSCROLLEVENT_SCROLLSTATE_IDX                         = 736,
    SBK_QSCROLLEVENT_IDX                                     = 734,
    SBK_QSCROLLPREPAREEVENT_IDX                              = 738,
    SBK_QSESSIONMANAGER_RESTARTHINT_IDX                      = 742,
    SBK_QSESSIONMANAGER_IDX                                  = 740,
    SBK_QSHADER_STAGE_IDX                                    = 750,
    SBK_QSHADER_SOURCE_IDX                                   = 748,
    SBK_QSHADER_VARIANT_IDX                                  = 752,
    SBK_QSHADER_SERIALIZEDFORMATVERSION_IDX                  = 746,
    SBK_QSHADER_IDX                                          = 744,
    SBK_QSHADERCODE_IDX                                      = 754,
    SBK_QSHADERKEY_IDX                                       = 756,
    SBK_QSHADERVERSION_FLAG_IDX                              = 760,
    SBK_QFLAGS_QSHADERVERSION_FLAG_IDX                       = 214,
    SBK_QSHADERVERSION_IDX                                   = 758,
    SBK_QSHORTCUT_IDX                                        = 762,
    SBK_QSHORTCUTEVENT_IDX                                   = 764,
    SBK_QSHOWEVENT_IDX                                       = 766,
    SBK_QSINGLEPOINTEVENT_IDX                                = 768,
    SBK_QSTANDARDITEM_ITEMTYPE_IDX                           = 772,
    SBK_QSTANDARDITEM_IDX                                    = 770,
    SBK_QSTANDARDITEMMODEL_IDX                               = 774,
    SBK_QSTATICTEXT_PERFORMANCEHINT_IDX                      = 778,
    SBK_QSTATICTEXT_IDX                                      = 776,
    SBK_QSTATUSTIPEVENT_IDX                                  = 780,
    SBK_QSTYLEHINTS_IDX                                      = 782,
    SBK_QSURFACE_SURFACECLASS_IDX                            = 786,
    SBK_QSURFACE_SURFACETYPE_IDX                             = 788,
    SBK_QSURFACE_IDX                                         = 784,
    SBK_QSURFACEFORMAT_FORMATOPTION_IDX                      = 794,
    SBK_QFLAGS_QSURFACEFORMAT_FORMATOPTION_IDX               = 216,
    SBK_QSURFACEFORMAT_SWAPBEHAVIOR_IDX                      = 800,
    SBK_QSURFACEFORMAT_RENDERABLETYPE_IDX                    = 798,
    SBK_QSURFACEFORMAT_OPENGLCONTEXTPROFILE_IDX              = 796,
    SBK_QSURFACEFORMAT_COLORSPACE_IDX                        = 792,
    SBK_QSURFACEFORMAT_IDX                                   = 790,
    SBK_QSYNTAXHIGHLIGHTER_IDX                               = 802,
    SBK_QTABLETEVENT_IDX                                     = 804,
    SBK_QTEXTBLOCK_IDX                                       = 806,
    SBK_QTEXTBLOCK_ITERATOR_IDX                              = 808,
    SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                 = 970,
    SBK_QTEXTBLOCKFORMAT_MARKERTYPE_IDX                      = 812,
    SBK_QTEXTBLOCKFORMAT_IDX                                 = 810,
    SBK_QTEXTBLOCKGROUP_IDX                                  = 814,
    SBK_QTEXTBLOCKUSERDATA_IDX                               = 816,
    SBK_QTEXTCHARFORMAT_VERTICALALIGNMENT_IDX                = 824,
    SBK_QTEXTCHARFORMAT_UNDERLINESTYLE_IDX                   = 822,
    SBK_QTEXTCHARFORMAT_FONTPROPERTIESINHERITANCEBEHAVIOR_IDX = 820,
    SBK_QTEXTCHARFORMAT_IDX                                  = 818,
    SBK_QTEXTCURSOR_MOVEMODE_IDX                             = 828,
    SBK_QTEXTCURSOR_MOVEOPERATION_IDX                        = 830,
    SBK_QTEXTCURSOR_SELECTIONTYPE_IDX                        = 832,
    SBK_QTEXTCURSOR_IDX                                      = 826,
    SBK_QTEXTDOCUMENT_METAINFORMATION_IDX                    = 840,
    SBK_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX                    = 838,
    SBK_QFLAGS_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX             = 220,
    SBK_QTEXTDOCUMENT_FINDFLAG_IDX                           = 836,
    SBK_QFLAGS_QTEXTDOCUMENT_FINDFLAG_IDX                    = 218,
    SBK_QTEXTDOCUMENT_RESOURCETYPE_IDX                       = 842,
    SBK_QTEXTDOCUMENT_STACKS_IDX                             = 844,
    SBK_QTEXTDOCUMENT_IDX                                    = 834,
    SBK_QTEXTDOCUMENTFRAGMENT_IDX                            = 846,
    SBK_QTEXTDOCUMENTWRITER_IDX                              = 848,
    SBK_QTEXTFORMAT_FORMATTYPE_IDX                           = 852,
    SBK_QTEXTFORMAT_PROPERTY_IDX                             = 858,
    SBK_QTEXTFORMAT_OBJECTTYPES_IDX                          = 854,
    SBK_QTEXTFORMAT_PAGEBREAKFLAG_IDX                        = 856,
    SBK_QFLAGS_QTEXTFORMAT_PAGEBREAKFLAG_IDX                 = 222,
    SBK_QTEXTFORMAT_IDX                                      = 850,
    SBK_QTEXTFRAGMENT_IDX                                    = 860,
    SBK_QTEXTFRAME_IDX                                       = 862,
    SBK_QTEXTFRAME_ITERATOR_IDX                              = 864,
    SBK_QTEXTFRAMEFORMAT_POSITION_IDX                        = 870,
    SBK_QTEXTFRAMEFORMAT_BORDERSTYLE_IDX                     = 868,
    SBK_QTEXTFRAMEFORMAT_IDX                                 = 866,
    SBK_QTEXTIMAGEFORMAT_IDX                                 = 872,
    SBK_QTEXTINLINEOBJECT_IDX                                = 874,
    SBK_QTEXTITEM_RENDERFLAG_IDX                             = 878,
    SBK_QFLAGS_QTEXTITEM_RENDERFLAG_IDX                      = 224,
    SBK_QTEXTITEM_IDX                                        = 876,
    SBK_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX                = 886,
    SBK_QFLAGS_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX         = 226,
    SBK_QTEXTLAYOUT_CURSORMODE_IDX                           = 882,
    SBK_QTEXTLAYOUT_IDX                                      = 880,
    SBK_QTEXTLAYOUT_FORMATRANGE_IDX                          = 884,
    SBK_QTEXTLENGTH_TYPE_IDX                                 = 890,
    SBK_QTEXTLENGTH_IDX                                      = 888,
    SBK_QTEXTLINE_EDGE_IDX                                   = 896,
    SBK_QTEXTLINE_CURSORPOSITION_IDX                         = 894,
    SBK_QTEXTLINE_IDX                                        = 892,
    SBK_QTEXTLIST_IDX                                        = 898,
    SBK_QTEXTLISTFORMAT_STYLE_IDX                            = 902,
    SBK_QTEXTLISTFORMAT_IDX                                  = 900,
    SBK_QTEXTOBJECT_IDX                                      = 904,
    SBK_QTEXTOBJECTINTERFACE_IDX                             = 906,
    SBK_QTEXTOPTION_TABTYPE_IDX                              = 914,
    SBK_QTEXTOPTION_WRAPMODE_IDX                             = 916,
    SBK_QTEXTOPTION_FLAG_IDX                                 = 910,
    SBK_QFLAGS_QTEXTOPTION_FLAG_IDX                          = 228,
    SBK_QTEXTOPTION_IDX                                      = 908,
    SBK_QTEXTOPTION_TAB_IDX                                  = 912,
    SBK_QTEXTTABLE_IDX                                       = 918,
    SBK_QTEXTTABLECELL_IDX                                   = 920,
    SBK_QTEXTTABLECELLFORMAT_IDX                             = 922,
    SBK_QTEXTTABLEFORMAT_IDX                                 = 924,
    SBK_QTOOLBARCHANGEEVENT_IDX                              = 926,
    SBK_QTOUCHEVENT_IDX                                      = 928,
    SBK_QTRANSFORM_TRANSFORMATIONTYPE_IDX                    = 932,
    SBK_QTRANSFORM_IDX                                       = 930,
    SBK_QUNDOCOMMAND_IDX                                     = 934,
    SBK_QUNDOGROUP_IDX                                       = 936,
    SBK_QUNDOSTACK_IDX                                       = 938,
    SBK_QVALIDATOR_STATE_IDX                                 = 942,
    SBK_QVALIDATOR_IDX                                       = 940,
    SBK_QVECTOR2D_IDX                                        = 944,
    SBK_QVECTOR3D_IDX                                        = 946,
    SBK_QVECTOR4D_IDX                                        = 948,
    SBK_QWHATSTHISCLICKEDEVENT_IDX                           = 950,
    SBK_QWHEELEVENT_IDX                                      = 952,
    SBK_QWINDOW_VISIBILITY_IDX                               = 958,
    SBK_QWINDOW_ANCESTORMODE_IDX                             = 956,
    SBK_QWINDOW_IDX                                          = 954,
    SBK_QWINDOWSTATECHANGEEVENT_IDX                          = 960,
    SBK_QTGUIQT_IDX                                          = 962,
    SBK_QTGUIHELPER_QOVERRIDECURSORGUARD_IDX                 = 966,
    SBK_QTGUI_IDX_COUNT                                      = 972,
};
...
enum : int {
    ...
    SBK_QFont_HintingPreference_IDX                          = 484,
    ...
    SBK_QNativeInterface_QWindowsScreen_IDX                  = 195,
    ...
    SBK_QRhiD3D11InitParams_IDX                              = 292,
    SBK_QRhiD3D11NativeHandles_IDX                           = 293,
    SBK_QRhiD3D12InitParams_IDX                              = 294,
    SBK_QRhiD3D12NativeHandles_IDX                           = 295,
    ...
    SBK_QRhiNativeHandles_IDX                                = 315,
    SBK_QRhiNullInitParams_IDX                               = 316,
    SBK_QRhiReadbackDescription_IDX                          = 317,
    SBK_QRhiReadbackResult_IDX                               = 318,
    SBK_QRhiRenderBuffer_Type_IDX                            = 321,
    SBK_QRhiRenderBuffer_Flag_IDX                            = 320,
    SBK_QFlags_QRhiRenderBuffer_Flag_IDX                     = 101,
    SBK_QRhiRenderBuffer_IDX                                 = 319,
    SBK_QRhiRenderPassDescriptor_IDX                         = 322,
    SBK_QRhiRenderTarget_IDX                                 = 323,
    SBK_QRhiResource_Type_IDX                                = 325,
    SBK_QRhiResource_IDX                                     = 324,
    SBK_QRhiResourceUpdateBatch_IDX                          = 326,
    SBK_QRhiSampler_Filter_IDX                               = 330,
    SBK_QRhiSampler_AddressMode_IDX                          = 328,
    SBK_QRhiSampler_CompareOp_IDX                            = 329,
    SBK_QRhiSampler_IDX                                      = 327,
    SBK_QRhiScissor_IDX                                      = 331,
    SBK_QRhiShaderResourceBinding_Type_IDX                   = 338,
    SBK_QRhiShaderResourceBinding_StageFlag_IDX              = 336,
    SBK_QFlags_QRhiShaderResourceBinding_StageFlag_IDX       = 102,
    SBK_QRhiShaderResourceBinding_IDX                        = 332,
    SBK_QRhiShaderResourceBinding_Data_IDX                   = 333,
    SBK_QRhiShaderResourceBinding_Data_StorageBufferData_IDX = 334,
    SBK_QRhiShaderResourceBinding_Data_StorageImageData_IDX  = 335,
    SBK_QRhiShaderResourceBinding_TextureAndSampler_IDX      = 337,
    SBK_QRhiShaderResourceBindings_UpdateFlag_IDX            = 340,
    SBK_QFlags_QRhiShaderResourceBindings_UpdateFlag_IDX     = 103,
    SBK_QRhiShaderResourceBindings_IDX                       = 339,
    SBK_QRhiShaderStage_Type_IDX                             = 342,
    SBK_QRhiShaderStage_IDX                                  = 341,
    SBK_QRhiStats_IDX                                        = 343,
    SBK_QRhiSwapChain_Flag_IDX                               = 345,
    SBK_QFlags_QRhiSwapChain_Flag_IDX                        = 104,
    SBK_QRhiSwapChain_Format_IDX                             = 346,
    SBK_QRhiSwapChain_StereoTargetBuffer_IDX                 = 347,
    SBK_QRhiSwapChain_IDX                                    = 344,
    SBK_QRhiSwapChainRenderTarget_IDX                        = 348,
    SBK_QRhiTexture_Flag_IDX                                 = 350,
    SBK_QFlags_QRhiTexture_Flag_IDX                          = 105,
    SBK_QRhiTexture_Format_IDX                               = 351,
    SBK_QRhiTexture_IDX                                      = 349,
    SBK_QRhiTexture_ViewFormat_IDX                           = 352,
    SBK_QRhiTextureCopyDescription_IDX                       = 353,
    SBK_QRhiTextureRenderTarget_Flag_IDX                     = 355,
    SBK_QFlags_QRhiTextureRenderTarget_Flag_IDX              = 106,
    SBK_QRhiTextureRenderTarget_IDX                          = 354,
    SBK_QRhiTextureRenderTargetDescription_IDX               = 356,
    SBK_QRhiTextureSubresourceUploadDescription_IDX          = 357,
    SBK_QRhiTextureUploadDescription_IDX                     = 358,
    SBK_QRhiTextureUploadEntry_IDX                           = 359,
    SBK_QRhiVertexInputAttribute_Format_IDX                  = 361,
    SBK_QRhiVertexInputAttribute_IDX                         = 360,
    SBK_QRhiVertexInputBinding_Classification_IDX            = 363,
    SBK_QRhiVertexInputBinding_IDX                           = 362,
    SBK_QRhiVertexInputLayout_IDX                            = 364,
    SBK_QRhiViewport_IDX                                     = 365,
    SBK_QScreen_IDX                                          = 366,
    SBK_QScrollEvent_ScrollState_IDX                         = 368,
    SBK_QScrollEvent_IDX                                     = 367,
    SBK_QScrollPrepareEvent_IDX                              = 369,
    SBK_QSessionManager_RestartHint_IDX                      = 371,
    SBK_QSessionManager_IDX                                  = 370,
    SBK_QShader_Stage_IDX                                    = 375,
    SBK_QShader_Source_IDX                                   = 374,
    SBK_QShader_Variant_IDX                                  = 376,
    SBK_QShader_SerializedFormatVersion_IDX                  = 373,
    SBK_QShader_IDX                                          = 372,
    SBK_QShaderCode_IDX                                      = 377,
    SBK_QShaderKey_IDX                                       = 378,
    SBK_QShaderVersion_Flag_IDX                              = 380,
    SBK_QFlags_QShaderVersion_Flag_IDX                       = 107,
    SBK_QShaderVersion_IDX                                   = 379,
    SBK_QShortcut_IDX                                        = 381,
    SBK_QShortcutEvent_IDX                                   = 382,
    SBK_QShowEvent_IDX                                       = 383,
    SBK_QSinglePointEvent_IDX                                = 384,
    SBK_QStandardItem_ItemType_IDX                           = 386,
    SBK_QStandardItem_IDX                                    = 385,
    SBK_QStandardItemModel_IDX                               = 387,
    SBK_QStaticText_PerformanceHint_IDX                      = 389,
    SBK_QStaticText_IDX                                      = 388,
    SBK_QStatusTipEvent_IDX                                  = 390,
    SBK_QStyleHints_IDX                                      = 391,
    SBK_QSurface_SurfaceClass_IDX                            = 393,
    SBK_QSurface_SurfaceType_IDX                             = 394,
    SBK_QSurface_IDX                                         = 392,
    SBK_QSurfaceFormat_FormatOption_IDX                      = 397,
    SBK_QFlags_QSurfaceFormat_FormatOption_IDX               = 108,
    SBK_QSurfaceFormat_SwapBehavior_IDX                      = 400,
    SBK_QSurfaceFormat_RenderableType_IDX                    = 399,
    SBK_QSurfaceFormat_OpenGLContextProfile_IDX              = 398,
    SBK_QSurfaceFormat_ColorSpace_IDX                        = 396,
    SBK_QSurfaceFormat_IDX                                   = 395,
    SBK_QSyntaxHighlighter_IDX                               = 401,
    SBK_QTabletEvent_IDX                                     = 402,
    SBK_QTextBlock_IDX                                       = 403,
    SBK_QTextBlock_iterator_IDX                              = 404,
    SBK_QTextBlockFormat_LineHeightTypes_IDX                 = 485,
    SBK_QTextBlockFormat_MarkerType_IDX                      = 406,
    SBK_QTextBlockFormat_IDX                                 = 405,
    SBK_QTextBlockGroup_IDX                                  = 407,
    SBK_QTextBlockUserData_IDX                               = 408,
    SBK_QTextCharFormat_VerticalAlignment_IDX                = 412,
    SBK_QTextCharFormat_UnderlineStyle_IDX                   = 411,
    SBK_QTextCharFormat_FontPropertiesInheritanceBehavior_IDX = 410,
    SBK_QTextCharFormat_IDX                                  = 409,
    SBK_QTextCursor_MoveMode_IDX                             = 414,
    SBK_QTextCursor_MoveOperation_IDX                        = 415,
    SBK_QTextCursor_SelectionType_IDX                        = 416,
    SBK_QTextCursor_IDX                                      = 413,
    SBK_QTextDocument_MetaInformation_IDX                    = 420,
    SBK_QTextDocument_MarkdownFeature_IDX                    = 419,
    SBK_QFlags_QTextDocument_MarkdownFeature_IDX             = 110,
    SBK_QTextDocument_FindFlag_IDX                           = 418,
    SBK_QFlags_QTextDocument_FindFlag_IDX                    = 109,
    SBK_QTextDocument_ResourceType_IDX                       = 421,
    SBK_QTextDocument_Stacks_IDX                             = 422,
    SBK_QTextDocument_IDX                                    = 417,
    SBK_QTextDocumentFragment_IDX                            = 423,
    SBK_QTextDocumentWriter_IDX                              = 424,
    SBK_QTextFormat_FormatType_IDX                           = 426,
    SBK_QTextFormat_Property_IDX                             = 429,
    SBK_QTextFormat_ObjectTypes_IDX                          = 427,
    SBK_QTextFormat_PageBreakFlag_IDX                        = 428,
    SBK_QFlags_QTextFormat_PageBreakFlag_IDX                 = 111,
    SBK_QTextFormat_IDX                                      = 425,
    SBK_QTextFragment_IDX                                    = 430,
    SBK_QTextFrame_IDX                                       = 431,
    SBK_QTextFrame_iterator_IDX                              = 432,
    SBK_QTextFrameFormat_Position_IDX                        = 435,
    SBK_QTextFrameFormat_BorderStyle_IDX                     = 434,
    SBK_QTextFrameFormat_IDX                                 = 433,
    SBK_QTextImageFormat_IDX                                 = 436,
    SBK_QTextInlineObject_IDX                                = 437,
    SBK_QTextItem_RenderFlag_IDX                             = 439,
    SBK_QFlags_QTextItem_RenderFlag_IDX                      = 112,
    SBK_QTextItem_IDX                                        = 438,
    SBK_QTextLayout_GlyphRunRetrievalFlag_IDX                = 443,
    SBK_QFlags_QTextLayout_GlyphRunRetrievalFlag_IDX         = 113,
    SBK_QTextLayout_CursorMode_IDX                           = 441,
    SBK_QTextLayout_IDX                                      = 440,
    SBK_QTextLayout_FormatRange_IDX                          = 442,
    SBK_QTextLength_Type_IDX                                 = 445,
    SBK_QTextLength_IDX                                      = 444,
    SBK_QTextLine_Edge_IDX                                   = 448,
    SBK_QTextLine_CursorPosition_IDX                         = 447,
    SBK_QTextLine_IDX                                        = 446,
    SBK_QTextList_IDX                                        = 449,
    SBK_QTextListFormat_Style_IDX                            = 451,
    SBK_QTextListFormat_IDX                                  = 450,
    SBK_QTextObject_IDX                                      = 452,
    SBK_QTextObjectInterface_IDX                             = 453,
    SBK_QTextOption_TabType_IDX                              = 457,
    SBK_QTextOption_WrapMode_IDX                             = 458,
    SBK_QTextOption_Flag_IDX                                 = 455,
    SBK_QFlags_QTextOption_Flag_IDX                          = 114,
    SBK_QTextOption_IDX                                      = 454,
    SBK_QTextOption_Tab_IDX                                  = 456,
    SBK_QTextTable_IDX                                       = 459,
    SBK_QTextTableCell_IDX                                   = 460,
    SBK_QTextTableCellFormat_IDX                             = 461,
    SBK_QTextTableFormat_IDX                                 = 462,
    SBK_QToolBarChangeEvent_IDX                              = 463,
    SBK_QTouchEvent_IDX                                      = 464,
    SBK_QTransform_TransformationType_IDX                    = 466,
    SBK_QTransform_IDX                                       = 465,
    SBK_QUndoCommand_IDX                                     = 467,
    SBK_QUndoGroup_IDX                                       = 468,
    SBK_QUndoStack_IDX                                       = 469,
    SBK_QValidator_State_IDX                                 = 471,
    SBK_QValidator_IDX                                       = 470,
    SBK_QVector2D_IDX                                        = 472,
    SBK_QVector3D_IDX                                        = 473,
    SBK_QVector4D_IDX                                        = 474,
    SBK_QWhatsThisClickedEvent_IDX                           = 475,
    SBK_QWheelEvent_IDX                                      = 476,
    SBK_QWindow_Visibility_IDX                               = 479,
    SBK_QWindow_AncestorMode_IDX                             = 478,
    SBK_QWindow_IDX                                          = 477,
    SBK_QWindowStateChangeEvent_IDX                          = 480,
    SBK_QtGuiQt_IDX                                          = 481,
    SBK_QtGuiHelper_QOverrideCursorGuard_IDX                 = 483,
    SBK_QtGui_IDX_COUNT                                      = 486,
};
...
enum [[deprecated]] : int {
    ...
    SBK_QTGUI_QLIST_QACCESSIBLE_ATTRIBUTE_IDX                = 82, // QList<QAccessible::Attribute>
    SBK_QTGUI_QLIST_UNSIGNEDINT_IDX                          = 84, // QList<unsigned int>
    SBK_QTGUI_QLIST_QLINE_IDX                                = 86, // QList<QLine>
    SBK_QTGUI_QLIST_QLINEF_IDX                               = 88, // QList<QLineF>
    SBK_QTGUI_QLIST_QRECT_IDX                                = 90, // QList<QRect>
    SBK_QTGUI_QLIST_QRECTF_IDX                               = 92, // QList<QRectF>
    SBK_QTGUI_QLIST_QKEYSEQUENCE_IDX                         = 94, // QList<QKeySequence>
    SBK_QTGUI_QLIST_QOBJECTPTR_IDX                           = 96, // QList<QObject*>
    SBK_QTGUI_QLIST_QBYTEARRAY_IDX                           = 98, // QList<QByteArray>
    SBK_QTGUI_QLIST_QUNDOSTACKPTR_IDX                        = 100, // QList<QUndoStack*>
    SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                        = 102, // QList<QTextFrame*>
    SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                           = 104, // QList<QTextBlock>
    SBK_QTGUI_QLIST_QTEXTFORMAT_IDX                          = 106, // QList<QTextFormat>
    SBK_QTGUI_QLIST_QSCREENPTR_IDX                           = 108, // QList<QScreen*>
    SBK_QTGUI_QLIST_QOPENGLCONTEXTPTR_IDX                    = 110, // QList<QOpenGLContext*>
    SBK_QTGUI_QSET_QBYTEARRAY_IDX                            = 112, // QSet<QByteArray>
    SBK_QTGUI_QLIST_CONSTQINPUTDEVICEPTR_IDX                 = 114, // QList<const QInputDevice*>
    SBK_QTGUI_QLIST_QACTIONPTR_IDX                           = 116, // QList<QAction*>
    ...
    SBK_QTGUI_QLIST_QRHISHADERRESOURCEBINDING_IDX            = 126, // QList<QRhiShaderResourceBinding>
    SBK_QTGUI_QLIST_QRHISHADERSTAGE_IDX                      = 128, // QList<QRhiShaderStage>
    SBK_QTGUI_QLIST_QRHIGRAPHICSPIPELINE_TARGETBLEND_IDX     = 130, // QList<QRhiGraphicsPipeline::TargetBlend>
    SBK_QTGUI_STD_PAIR_INT_UNSIGNEDINT_IDX                   = 132, // std::pair<int,unsigned int>
    SBK_QTGUI_STD_PAIR_QRHIBUFFERPTR_QUINT32_IDX             = 134, // std::pair<QRhiBuffer*,quint32>
    SBK_QTGUI_QLIST_STD_PAIR_QRHIBUFFERPTR_QUINT32_IDX       = 136, // QList<std::pair<QRhiBuffer*,quint32>>
    SBK_QTGUI_STD_PAIR_QRHIBUFFERPTR_UNSIGNEDINT_IDX         = 138, // std::pair<QRhiBuffer*,unsigned int>
    SBK_QTGUI_QLIST_QMODELINDEX_IDX                          = 140, // QList<QModelIndex>
    SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                       = 142, // QHash<int,QByteArray>
    SBK_QTGUI_QLIST_QVARIANT_IDX                             = 144, // QList<QVariant>
    SBK_QTGUI_QLIST_QSTRING_IDX                              = 146, // QList<QString>
    SBK_QTGUI_QMAP_QSTRING_QVARIANT_IDX                      = 148, // QMap<QString,QVariant>
    SBK_QTGUI_CONVERTERS_IDX_COUNT                           = 150,
};
...
enum : int {
    ...
    SBK_QtGui_QList_QAccessible_Attribute_IDX                = 41, // QList<QAccessible::Attribute>
    SBK_QtGui_QList_unsignedint_IDX                          = 42, // QList<unsigned int>
    SBK_QtGui_QList_QLine_IDX                                = 43, // QList<QLine>
    SBK_QtGui_QList_QLineF_IDX                               = 44, // QList<QLineF>
    SBK_QtGui_QList_QRect_IDX                                = 45, // QList<QRect>
    SBK_QtGui_QList_QRectF_IDX                               = 46, // QList<QRectF>
    SBK_QtGui_QList_QKeySequence_IDX                         = 47, // QList<QKeySequence>
    SBK_QtGui_QList_QObjectPTR_IDX                           = 48, // QList<QObject*>
    SBK_QtGui_QList_QByteArray_IDX                           = 49, // QList<QByteArray>
    ...
    SBK_QtGui_QList_QRhiShaderResourceBinding_IDX            = 63, // QList<QRhiShaderResourceBinding>
    SBK_QtGui_QList_QRhiShaderStage_IDX                      = 64, // QList<QRhiShaderStage>
    SBK_QtGui_QList_QRhiGraphicsPipeline_TargetBlend_IDX     = 65, // QList<QRhiGraphicsPipeline::TargetBlend>
    SBK_QtGui_std_pair_int_unsignedint_IDX                   = 66, // std::pair<int,unsigned int>
    SBK_QtGui_std_pair_QRhiBufferPTR_quint32_IDX             = 67, // std::pair<QRhiBuffer*,quint32>
    SBK_QtGui_QList_std_pair_QRhiBufferPTR_quint32_IDX       = 68, // QList<std::pair<QRhiBuffer*,quint32>>
    SBK_QtGui_std_pair_QRhiBufferPTR_unsignedint_IDX         = 69, // std::pair<QRhiBuffer*,unsigned int>
    SBK_QtGui_QList_QModelIndex_IDX                          = 70, // QList<QModelIndex>
    SBK_QtGui_QHash_int_QByteArray_IDX                       = 71, // QHash<int,QByteArray>
    SBK_QtGui_QList_QVariant_IDX                             = 72, // QList<QVariant>
    SBK_QtGui_QList_QString_IDX                              = 73, // QList<QString>
    SBK_QtGui_QMap_QString_QVariant_IDX                      = 74, // QMap<QString,QVariant>
    SBK_QtGui_CONVERTERS_IDX_COUNT                           = 75,
};

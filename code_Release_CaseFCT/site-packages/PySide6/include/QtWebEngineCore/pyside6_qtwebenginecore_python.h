...
enum [[deprecated]] : int {
    ...
    SBK_QWEBENGINEDOWNLOADREQUEST_DOWNLOADSTATE_IDX          = 36,
    SBK_QWEBENGINEDOWNLOADREQUEST_SAVEPAGEFORMAT_IDX         = 38,
    SBK_QWEBENGINEDOWNLOADREQUEST_DOWNLOADINTERRUPTREASON_IDX = 34,
    SBK_QWEBENGINEDOWNLOADREQUEST_IDX                        = 32,
    SBK_QWEBENGINEFILESYSTEMACCESSREQUEST_HANDLETYPE_IDX     = 44,
    SBK_QWEBENGINEFILESYSTEMACCESSREQUEST_ACCESSFLAG_IDX     = 42,
    SBK_QFLAGS_QWEBENGINEFILESYSTEMACCESSREQUEST_ACCESSFLAG_IDX = 4,
    SBK_QWEBENGINEFILESYSTEMACCESSREQUEST_IDX                = 40,
    SBK_QWEBENGINEFINDTEXTRESULT_IDX                         = 46,
    SBK_QWEBENGINEFRAME_IDX                                  = 48,
    SBK_QWEBENGINEFULLSCREENREQUEST_IDX                      = 50,
    SBK_QWEBENGINEGLOBALSETTINGS_SECUREDNSMODE_IDX           = 56,
    SBK_QTWEBENGINECOREQWEBENGINEGLOBALSETTINGS_IDX          = 52,
    SBK_QWEBENGINEGLOBALSETTINGS_DNSMODE_IDX                 = 54,
    SBK_QWEBENGINEHISTORY_IDX                                = 58,
    SBK_QWEBENGINEHISTORYITEM_IDX                            = 60,
    SBK_QWEBENGINEHISTORYMODEL_ROLES_IDX                     = 64,
    SBK_QWEBENGINEHISTORYMODEL_IDX                           = 62,
    SBK_QWEBENGINEHTTPREQUEST_METHOD_IDX                     = 68,
    SBK_QWEBENGINEHTTPREQUEST_IDX                            = 66,
    SBK_QWEBENGINELOADINGINFO_LOADSTATUS_IDX                 = 74,
    SBK_QWEBENGINELOADINGINFO_ERRORDOMAIN_IDX                = 72,
    SBK_QWEBENGINELOADINGINFO_IDX                            = 70,
    SBK_QWEBENGINENAVIGATIONREQUEST_NAVIGATIONTYPE_IDX       = 80,
    SBK_QWEBENGINENAVIGATIONREQUEST_NAVIGATIONREQUESTACTION_IDX = 78,
    SBK_QWEBENGINENAVIGATIONREQUEST_IDX                      = 76,
    SBK_QWEBENGINENEWWINDOWREQUEST_DESTINATIONTYPE_IDX       = 84,
    SBK_QWEBENGINENEWWINDOWREQUEST_IDX                       = 82,
    SBK_QWEBENGINENOTIFICATION_IDX                           = 86,
    SBK_QWEBENGINEPAGE_WEBACTION_IDX                         = 106,
    SBK_QWEBENGINEPAGE_FINDFLAG_IDX                          = 94,
    SBK_QFLAGS_QWEBENGINEPAGE_FINDFLAG_IDX                   = 6,
    SBK_QWEBENGINEPAGE_WEBWINDOWTYPE_IDX                     = 108,
    SBK_QWEBENGINEPAGE_PERMISSIONPOLICY_IDX                  = 102,
    SBK_QWEBENGINEPAGE_NAVIGATIONTYPE_IDX                    = 100,
    SBK_QWEBENGINEPAGE_FEATURE_IDX                           = 90,
    SBK_QWEBENGINEPAGE_FILESELECTIONMODE_IDX                 = 92,
    SBK_QWEBENGINEPAGE_JAVASCRIPTCONSOLEMESSAGELEVEL_IDX     = 96,
    SBK_QWEBENGINEPAGE_RENDERPROCESSTERMINATIONSTATUS_IDX    = 104,
    SBK_QWEBENGINEPAGE_LIFECYCLESTATE_IDX                    = 98,
    SBK_QWEBENGINEPAGE_IDX                                   = 88,
    SBK_QWEBENGINEPERMISSION_PERMISSIONTYPE_IDX              = 112,
    SBK_QWEBENGINEPERMISSION_STATE_IDX                       = 114,
    SBK_QWEBENGINEPERMISSION_IDX                             = 110,
    SBK_QWEBENGINEPROFILE_HTTPCACHETYPE_IDX                  = 118,
    SBK_QWEBENGINEPROFILE_PERSISTENTCOOKIESPOLICY_IDX        = 120,
    SBK_QWEBENGINEPROFILE_PERSISTENTPERMISSIONSPOLICY_IDX    = 122,
    SBK_QWEBENGINEPROFILE_IDX                                = 116,
    SBK_QWEBENGINEQUOTAREQUEST_IDX                           = 124,
    SBK_QWEBENGINEREGISTERPROTOCOLHANDLERREQUEST_IDX         = 126,
    SBK_QWEBENGINESCRIPT_INJECTIONPOINT_IDX                  = 130,
    SBK_QWEBENGINESCRIPT_SCRIPTWORLDID_IDX                   = 132,
    SBK_QWEBENGINESCRIPT_IDX                                 = 128,
    SBK_QWEBENGINESCRIPTCOLLECTION_IDX                       = 134,
    SBK_QWEBENGINESETTINGS_FONTFAMILY_IDX                    = 138,
    SBK_QWEBENGINESETTINGS_WEBATTRIBUTE_IDX                  = 146,
    SBK_QWEBENGINESETTINGS_FONTSIZE_IDX                      = 140,
    SBK_QWEBENGINESETTINGS_UNKNOWNURLSCHEMEPOLICY_IDX        = 144,
    SBK_QWEBENGINESETTINGS_IMAGEANIMATIONPOLICY_IDX          = 142,
    SBK_QWEBENGINESETTINGS_IDX                               = 136,
    SBK_QWEBENGINEURLREQUESTINFO_RESOURCETYPE_IDX            = 152,
    SBK_QWEBENGINEURLREQUESTINFO_NAVIGATIONTYPE_IDX          = 150,
    SBK_QWEBENGINEURLREQUESTINFO_IDX                         = 148,
    SBK_QWEBENGINEURLREQUESTINTERCEPTOR_IDX                  = 154,
    SBK_QWEBENGINEURLREQUESTJOB_ERROR_IDX                    = 158,
    SBK_QWEBENGINEURLREQUESTJOB_IDX                          = 156,
    SBK_QWEBENGINEURLSCHEME_SYNTAX_IDX                       = 166,
    SBK_QWEBENGINEURLSCHEME_SPECIALPORT_IDX                  = 164,
    SBK_QWEBENGINEURLSCHEME_FLAG_IDX                         = 162,
    SBK_QFLAGS_QWEBENGINEURLSCHEME_FLAG_IDX                  = 8,
    SBK_QWEBENGINEURLSCHEME_IDX                              = 160,
    SBK_QWEBENGINEURLSCHEMEHANDLER_IDX                       = 168,
    SBK_QWEBENGINEWEBAUTHPINREQUEST_IDX                      = 170,
    SBK_QWEBENGINEWEBAUTHUXREQUEST_WEBAUTHUXSTATE_IDX        = 180,
    SBK_QWEBENGINEWEBAUTHUXREQUEST_PINENTRYREASON_IDX        = 176,
    SBK_QWEBENGINEWEBAUTHUXREQUEST_PINENTRYERROR_IDX         = 174,
    SBK_QWEBENGINEWEBAUTHUXREQUEST_REQUESTFAILUREREASON_IDX  = 178,
    SBK_QWEBENGINEWEBAUTHUXREQUEST_IDX                       = 172,
    SBK_QTWEBENGINECORE_IDX_COUNT                            = 182,
};
...
enum : int {
    ...
    SBK_QWebEngineDownloadRequest_DownloadState_IDX          = 18,
    SBK_QWebEngineDownloadRequest_SavePageFormat_IDX         = 19,
    SBK_QWebEngineDownloadRequest_DownloadInterruptReason_IDX = 17,
    SBK_QWebEngineDownloadRequest_IDX                        = 16,
    SBK_QWebEngineFileSystemAccessRequest_HandleType_IDX     = 22,
    SBK_QWebEngineFileSystemAccessRequest_AccessFlag_IDX     = 21,
    SBK_QFlags_QWebEngineFileSystemAccessRequest_AccessFlag_IDX = 2,
    SBK_QWebEngineFileSystemAccessRequest_IDX                = 20,
    SBK_QWebEngineFindTextResult_IDX                         = 23,
    SBK_QWebEngineFrame_IDX                                  = 24,
    SBK_QWebEngineFullScreenRequest_IDX                      = 25,
    SBK_QWebEngineGlobalSettings_SecureDnsMode_IDX           = 28,
    SBK_QtWebEngineCoreQWebEngineGlobalSettings_IDX          = 26,
    SBK_QWebEngineGlobalSettings_DnsMode_IDX                 = 27,
    SBK_QWebEngineHistory_IDX                                = 29,
    SBK_QWebEngineHistoryItem_IDX                            = 30,
    SBK_QWebEngineHistoryModel_Roles_IDX                     = 32,
    SBK_QWebEngineHistoryModel_IDX                           = 31,
    SBK_QWebEngineHttpRequest_Method_IDX                     = 34,
    SBK_QWebEngineHttpRequest_IDX                            = 33,
    SBK_QWebEngineLoadingInfo_LoadStatus_IDX                 = 37,
    SBK_QWebEngineLoadingInfo_ErrorDomain_IDX                = 36,
    SBK_QWebEngineLoadingInfo_IDX                            = 35,
    SBK_QWebEngineNavigationRequest_NavigationType_IDX       = 40,
    SBK_QWebEngineNavigationRequest_NavigationRequestAction_IDX = 39,
    SBK_QWebEngineNavigationRequest_IDX                      = 38,
    SBK_QWebEngineNewWindowRequest_DestinationType_IDX       = 42,
    SBK_QWebEngineNewWindowRequest_IDX                       = 41,
    SBK_QWebEngineNotification_IDX                           = 43,
    SBK_QWebEnginePage_WebAction_IDX                         = 53,
    SBK_QWebEnginePage_FindFlag_IDX                          = 47,
    SBK_QFlags_QWebEnginePage_FindFlag_IDX                   = 3,
    SBK_QWebEnginePage_WebWindowType_IDX                     = 54,
    SBK_QWebEnginePage_PermissionPolicy_IDX                  = 51,
    SBK_QWebEnginePage_NavigationType_IDX                    = 50,
    SBK_QWebEnginePage_Feature_IDX                           = 45,
    SBK_QWebEnginePage_FileSelectionMode_IDX                 = 46,
    SBK_QWebEnginePage_JavaScriptConsoleMessageLevel_IDX     = 48,
    SBK_QWebEnginePage_RenderProcessTerminationStatus_IDX    = 52,
    SBK_QWebEnginePage_LifecycleState_IDX                    = 49,
    SBK_QWebEnginePage_IDX                                   = 44,
    SBK_QWebEnginePermission_PermissionType_IDX              = 56,
    SBK_QWebEnginePermission_State_IDX                       = 57,
    SBK_QWebEnginePermission_IDX                             = 55,
    SBK_QWebEngineProfile_HttpCacheType_IDX                  = 59,
    SBK_QWebEngineProfile_PersistentCookiesPolicy_IDX        = 60,
    SBK_QWebEngineProfile_PersistentPermissionsPolicy_IDX    = 61,
    SBK_QWebEngineProfile_IDX                                = 58,
    SBK_QWebEngineQuotaRequest_IDX                           = 62,
    SBK_QWebEngineRegisterProtocolHandlerRequest_IDX         = 63,
    SBK_QWebEngineScript_InjectionPoint_IDX                  = 65,
    SBK_QWebEngineScript_ScriptWorldId_IDX                   = 66,
    SBK_QWebEngineScript_IDX                                 = 64,
    SBK_QWebEngineScriptCollection_IDX                       = 67,
    SBK_QWebEngineSettings_FontFamily_IDX                    = 69,
    SBK_QWebEngineSettings_WebAttribute_IDX                  = 73,
    SBK_QWebEngineSettings_FontSize_IDX                      = 70,
    SBK_QWebEngineSettings_UnknownUrlSchemePolicy_IDX        = 72,
    SBK_QWebEngineSettings_ImageAnimationPolicy_IDX          = 71,
    SBK_QWebEngineSettings_IDX                               = 68,
    SBK_QWebEngineUrlRequestInfo_ResourceType_IDX            = 76,
    SBK_QWebEngineUrlRequestInfo_NavigationType_IDX          = 75,
    SBK_QWebEngineUrlRequestInfo_IDX                         = 74,
    SBK_QWebEngineUrlRequestInterceptor_IDX                  = 77,
    SBK_QWebEngineUrlRequestJob_Error_IDX                    = 79,
    SBK_QWebEngineUrlRequestJob_IDX                          = 78,
    SBK_QWebEngineUrlScheme_Syntax_IDX                       = 83,
    SBK_QWebEngineUrlScheme_SpecialPort_IDX                  = 82,
    SBK_QWebEngineUrlScheme_Flag_IDX                         = 81,
    SBK_QFlags_QWebEngineUrlScheme_Flag_IDX                  = 4,
    SBK_QWebEngineUrlScheme_IDX                              = 80,
    SBK_QWebEngineUrlSchemeHandler_IDX                       = 84,
    SBK_QWebEngineWebAuthPinRequest_IDX                      = 85,
    SBK_QWebEngineWebAuthUxRequest_WebAuthUxState_IDX        = 90,
    SBK_QWebEngineWebAuthUxRequest_PinEntryReason_IDX        = 88,
    SBK_QWebEngineWebAuthUxRequest_PinEntryError_IDX         = 87,
    SBK_QWebEngineWebAuthUxRequest_RequestFailureReason_IDX  = 89,
    SBK_QWebEngineWebAuthUxRequest_IDX                       = 86,
    SBK_QtWebEngineCore_IDX_COUNT                            = 91,
};

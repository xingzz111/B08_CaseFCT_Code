...
enum [[deprecated]] : int {
    ...
    SBK_QTPRINTSUPPORT_QLIST_QACTIONPTR_IDX                  = 14, // QList<QAction*>
    SBK_QTPRINTSUPPORT_QLIST_QVARIANT_IDX                    = 16, // QList<QVariant>
    SBK_QTPRINTSUPPORT_QLIST_QSTRING_IDX                     = 18, // QList<QString>
    SBK_QTPRINTSUPPORT_QMAP_QSTRING_QVARIANT_IDX             = 20, // QMap<QString,QVariant>
    SBK_QTPRINTSUPPORT_CONVERTERS_IDX_COUNT                  = 22,
};

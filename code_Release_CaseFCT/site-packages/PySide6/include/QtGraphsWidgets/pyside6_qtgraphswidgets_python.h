...
enum [[deprecated]] : int {
    ...
    SBK_QTGRAPHSWIDGETS_QLIST_QOBJECTPTR_IDX                 = 2, // QList<QObject*>
    SBK_QTGRAPHSWIDGETS_QLIST_QCUSTOM3DITEMPTR_IDX           = 4, // QList<QCustom3DItem*>
    SBK_QTGRAPHSWIDGETS_QLIST_QBYTEARRAY_IDX                 = 6, // QList<QByteArray>
    SBK_QTGRAPHSWIDGETS_QLIST_QGRAPHSTHEMEPTR_IDX            = 8, // QList<QGraphsTheme*>
    SBK_QTGRAPHSWIDGETS_QLIST_QVALUE3DAXISPTR_IDX            = 10, // QList<QValue3DAxis*>
    SBK_QTGRAPHSWIDGETS_QLIST_QSURFACE3DSERIESPTR_IDX        = 12, // QList<QSurface3DSeries*>
    SBK_QTGRAPHSWIDGETS_QLIST_QSCATTER3DSERIESPTR_IDX        = 14, // QList<QScatter3DSeries*>
    SBK_QTGRAPHSWIDGETS_QLIST_QABSTRACT3DAXISPTR_IDX         = 16, // QList<QAbstract3DAxis*>
    SBK_QTGRAPHSWIDGETS_QLIST_QBAR3DSERIESPTR_IDX            = 18, // QList<QBar3DSeries*>
    SBK_QTGRAPHSWIDGETS_QLIST_QVARIANT_IDX                   = 20, // QList<QVariant>
    SBK_QTGRAPHSWIDGETS_QLIST_QSTRING_IDX                    = 22, // QList<QString>
    SBK_QTGRAPHSWIDGETS_QMAP_QSTRING_QVARIANT_IDX            = 24, // QMap<QString,QVariant>
    SBK_QTGRAPHSWIDGETS_CONVERTERS_IDX_COUNT                 = 26,
};

// Converter indices
enum : int {
    SBK_QtGraphsWidgets_QList_int_IDX                        = 0, // QList<int>
    SBK_QtGraphsWidgets_QList_QObjectPTR_IDX                 = 1, // QList<QObject*>
    SBK_QtGraphsWidgets_QList_QCustom3DItemPTR_IDX           = 2, // QList<QCustom3DItem*>
    SBK_QtGraphsWidgets_QList_QByteArray_IDX                 = 3, // QList<QByteArray>
    SBK_QtGraphsWidgets_QList_QGraphsThemePTR_IDX            = 4, // QList<QGraphsTheme*>
    SBK_QtGraphsWidgets_QList_QValue3DAxisPTR_IDX            = 5, // QList<QValue3DAxis*>
    SBK_QtGraphsWidgets_QList_QSurface3DSeriesPTR_IDX        = 6, // QList<QSurface3DSeries*>
    SBK_QtGraphsWidgets_QList_QScatter3DSeriesPTR_IDX        = 7, // QList<QScatter3DSeries*>
    SBK_QtGraphsWidgets_QList_QAbstract3DAxisPTR_IDX         = 8, // QList<QAbstract3DAxis*>
    SBK_QtGraphsWidgets_QList_QBar3DSeriesPTR_IDX            = 9, // QList<QBar3DSeries*>
    SBK_QtGraphsWidgets_QList_QVariant_IDX                   = 10, // QList<QVariant>
    SBK_QtGraphsWidgets_QList_QString_IDX                    = 11, // QList<QString>
    SBK_QtGraphsWidgets_QMap_QString_QVariant_IDX            = 12, // QMap<QString,QVariant>
    SBK_QtGraphsWidgets_CONVERTERS_IDX_COUNT                 = 13,
};

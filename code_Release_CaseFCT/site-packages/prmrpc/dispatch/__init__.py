...
import traceback
from ..exc import *
from ..protocols.jsonrpc import JSONRPCServerError, JSONRPCMethodNotFoundError, JSONRPCInvalidRequestError
...
class RPCDispatcher(object):
    ...
    def _dispatch(self, request):
        try:
            ...
            # we found the method
            try:
                # print('method:', request.method, ' args:', request.args, ' kwargs:', request.kwargs)
                result = method(*request.args, **request.kwargs)
            except Exception as e:
                msg = traceback.format_exc(e)
                print(msg)
                # an error occurred within the method, return it
                # e = '{}: {}'.format(str(e), traceback.format_exc())
                return request.error_respond(JSONRPCInvalidRequestError(msg))
            ...
            # msg = '{}: {}'.format(e, traceback.format_exc())
    ...
    def register_instance(self, obj):
        ...
        if not isinstance(obj, dict):
            obj = {'': obj}
        for prefix, instance in obj.items():
    ...
    def get_public(self, obj):
        ...
        if hasattr(obj, 'rpc_public_api'):
            try:
                ...
                # print("**************{}".format(obj.rpc_public_api))
